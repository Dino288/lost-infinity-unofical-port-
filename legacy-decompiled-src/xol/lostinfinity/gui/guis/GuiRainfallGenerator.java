...
public class GuiRainfallGenerator
extends GuiContainer {
    public static final int WIDTH = 175;
    public static final int HEIGHT = 165;
    private static final ResourceLocation background = new ResourceLocation("lostinfinity", "textures/gui/rainfall_generator.png");
    private final Inventory player;
    private final BlockEntityRainfallGenerator tileentity;

    public GuiRainfallGenerator(Inventory player, BlockEntityRainfallGenerator tileEntityRainfallGenerator) {
        super((Container)new ContainerRainfallGenerator(player, tileEntityRainfallGenerator));
        this.player = player;
