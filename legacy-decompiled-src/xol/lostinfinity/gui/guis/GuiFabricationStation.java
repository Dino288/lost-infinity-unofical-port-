...
public class GuiFabricationStation
extends GuiContainer {
    private static final ResourceLocation texture = new ResourceLocation("lostinfinity", "textures/gui/fabrication_station.png");
    private final ContainerFabricationStation sFab;
    private final Inventory playerInventory;
    private GuiTextField nameField;

    public GuiFabricationStation(Inventory invPlayer, Level worldIn, BlockPos pos, Block block) {
        super((Container)new ContainerFabricationStation(invPlayer, worldIn, pos, block));
        ...
        if (this.sFab.status != ContainerFabricationStation.FabricationStatus.AWAITING_INPUT) {
            ...
            if (flag) {
                ...
                if (this.field_146289_q.func_82883_a()) {
                    GuiFabricationStation.func_73734_a((int)(k - 3), (int)65, (int)(this.field_146999_f - 7), (int)77, (int)-16777216);
                    GuiFabricationStation.func_73734_a((int)(k - 2), (int)66, (int)(this.field_146999_f - 8), (int)76, (int)-12895429);
                } else {
    ...
    protected void func_146976_a(float partialTicks, int mouseX, int mouseY) {
        ...
        if (!this.sFab.func_75139_a(7).func_75216_d()) {
            this.func_73729_b(i + 96, j + 33, this.field_146999_f, 0, 28, 21);
        }
    }
}
