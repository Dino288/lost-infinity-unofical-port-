...
public class ContainerCombustionEngine
extends Container {
    private final BlockEntityCombustionEngine tileentity;
    private int burnTime;
    private int currentBurnTime;

    public ContainerCombustionEngine(Inventory player, BlockEntityCombustionEngine tileEntityCombustionEngine) {
        this.tileentity = tileEntityCombustionEngine;
        this.func_75146_a(new Slot(tileEntityCombustionEngine, 0, 80, 28){

            public boolean func_75214_a(ItemStack stack) {
                return BlockEntityCombustionEngine.isItemFuel(stack);
            }
    ...
    public ItemStack func_82846_b(Player playerIn, int index) {
        ...
        if (slot != null && slot.func_75216_d()) {
            ...
            } else if (index != 1 && index != 0 ? (BlockEntityCombustionEngine.isItemFuel(itemstack1) ? !this.func_75135_a(itemstack1, 0, 1, false) : (index >= 3 && index < 30 ? !this.func_75135_a(itemstack1, 28, 37, false) : index >= 30 && index < 39 && !this.func_75135_a(itemstack1, 1, 28, false))) : !this.func_75135_a(itemstack1, 1, 37, false)) {
                return ItemStack.field_190927_a;
            }
