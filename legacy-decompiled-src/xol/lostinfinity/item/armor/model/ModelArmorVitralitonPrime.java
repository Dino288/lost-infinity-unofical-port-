...
public class ModelArmorVitralitonPrime
extends ModelLostArmor {
    ...
    public ModelArmorVitralitonPrime() {
        ...
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 86, 19, 3.0f, -6.5f, -5.0f, 1, 6, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 123, 5, 2.0f, -9.5f, 4.0f, 1, 9, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 123, 5, 4.0f, -10.5f, 1.0f, 1, 10, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 123, 5, 4.0f, -10.5f, -2.0f, 1, 10, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 123, 5, -5.0f, -10.5f, 1.0f, 1, 10, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 123, 5, -5.0f, -10.5f, -2.0f, 1, 10, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 111, 3, -4.0f, -9.5f, -2.0f, 1, 1, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 111, 3, -4.0f, -9.5f, 1.0f, 1, 1, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 95, 2, -2.0f, -8.5f, 4.0f, 4, 1, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 95, 2, -2.0f, -4.5f, 4.0f, 4, 1, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 95, 2, -2.0f, -2.5f, 4.0f, 4, 1, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 111, 3, 3.0f, -9.5f, 1.0f, 1, 1, 1, 0.0f, false));
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 111, 3, 3.0f, -9.5f, -2.0f, 1, 1, 1, 0.0f, false));
        ...
        this.field_78116_c.field_78804_l.add(new ModelBox(this.field_78116_c, 86, 19, -4.0f, -6.5f, -5.0f, 1, 6, 1, 0.0f, false));
        ...
        this.WingR.field_78804_l.add(new ModelBox(this.WingR, 81, 51, -2.0f, -10.0f, 9.0f, 1, 3, 1, 0.0f, false));
        this.WingR.field_78804_l.add(new ModelBox(this.WingR, 81, 51, 1.0f, -10.0f, 9.0f, 1, 3, 1, 0.0f, false));
        ...
        this.WingL.field_78804_l.add(new ModelBox(this.WingL, 81, 51, 1.0f, -10.0f, 9.0f, 1, 3, 1, 0.0f, true));
        this.WingL.field_78804_l.add(new ModelBox(this.WingL, 81, 51, -2.0f, -10.0f, 9.0f, 1, 3, 1, 0.0f, true));
