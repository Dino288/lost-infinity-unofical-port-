...
public class ItemSpectrosArmor
extends ItemLostArmor {
    private static final ArmorItem.ArmorMaterial SpectrosMaterial = EnumHelper.addArmorMaterial((String)"SpectrosArmor", (String)"lostinfinity:spectros_armor", (int)-1, (int[])new int[]{12, 24, 32, 12}, (int)20, (SoundEvent)SoundEvents.field_187716_o, (float)3.0f);
    ...
    public void spectreEffect(Level world, Player player, LivingEntity target, ItemStack stack) {
        if (!world.field_72995_K && this.isArmorActive(player, stack) && world.field_73012_v.nextInt(5) == 1) {
            int count = 0;
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add((Object)((Object)TextFmt.Red) + "20% Chance to Summon a Spectre When You Deal Max HP Damage");
    }
}
