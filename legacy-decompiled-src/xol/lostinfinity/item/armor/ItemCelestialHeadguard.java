...
public class ItemCelestialHeadguard
extends ArmorItem {
    public ItemCelestialHeadguard(ArmorItem.ArmorMaterial mat, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn, String regName) {
