...
public class ItemBionicVeggitronArmor
extends ItemLostArmor {
    private static final ArmorItem.ArmorMaterial BlightcystMaterial = EnumHelper.addArmorMaterial((String)"bionicveggitronArmor", (String)"lostinfinity:bionic_veggitron_armor", (int)-1, (int[])new int[]{12, 24, 32, 12}, (int)20, (SoundEvent)SoundEvents.field_187716_o, (float)3.0f);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add((Object)((Object)TextFmt.Gold) + "Summon a Pickle Man when you kill an entity.");
        tooltip.add((Object)((Object)TextFmt.Gold) + "When you take Max Health or True Damage:");
        tooltip.add((Object)((Object)TextFmt.Red) + "Sacrifice it to block the damage.");
    }
}
