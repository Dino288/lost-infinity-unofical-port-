...
public class ItemBiocorruptionPowder
extends Item {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!worldIn.field_72995_K) {
            Iterable nearblocks = BlockPos.func_177980_a((BlockPos)playerIn.func_180425_c().func_177982_a(-7, -7, -7), (BlockPos)playerIn.func_180425_c().func_177982_a(7, 7, 7));
            for (BlockPos pos : nearblocks) {
                if (worldIn.func_180495_p(pos).func_177230_c() != BlockInit.forgebloom) continue;
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Mutates nearby mushrooms.");
    }
}
