...
extends Item {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!worldIn.field_72995_K) {
            if (worldIn.field_73011_w.func_186058_p() != DimensionInit.nonexistence) {
                ...
                DimensionActivator.transferEntityWithCoords((Entity)playerIn, DimensionInit.nonexistence, teleport.func_177958_n(), teleport.func_177956_o(), teleport.func_177952_p());
            } else {
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Teleports you to the Galaxy Dungeon, located in Nonexistence.");
        tooltip.add(TextFmt.getFormatting(TextFmt.Aqua, TextFmt.Italic) + "The Galaxy Dungeon is where ancient warriors used to train.");
        tooltip.add((Object)((Object)TextFmt.Italic) + "Strength, Agility and Intelligence are all important in battle.");
    }
}
