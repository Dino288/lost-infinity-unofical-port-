...
extends Item {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!worldIn.field_72995_K) {
            if (worldIn.field_73011_w.func_186058_p() != DimensionInit.shadowSea) {
                DimensionActivator.transferEntityWithCoords((Entity)playerIn, DimensionInit.shadowSea, DimensionEffectRegistry.randomCoordinate(worldIn.field_73012_v), 160.0, DimensionEffectRegistry.randomCoordinate(worldIn.field_73012_v));
            } else {
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Aqua) + "Listen to the ocean and be taken away...");
    }
}
