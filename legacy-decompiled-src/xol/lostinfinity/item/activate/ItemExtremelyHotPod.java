...
public class ItemExtremelyHotPod
extends Item
implements IMaxAttack {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!worldIn.field_72995_K) {
            ...
            for (BlockPos pos : nearblocks) {
                if (worldIn.func_180495_p(pos).func_177230_c() != BlockInit.fungalBlockage) continue;
            ...
            IMaxAttack.dealTrueDamage(null, (LivingEntity)playerIn, playerIn.func_110138_aP() * 0.33f);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "An extremely hot pod good for melting very thick goo-ey substances.");
    }
}
