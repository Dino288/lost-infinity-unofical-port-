...
extends Item {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!worldIn.field_72995_K && playerIn.func_70090_H()) {
            for (int sl = 0; sl < 3; ++sl) {
                ...
                slime.func_70107_b(playerIn.field_70165_t, playerIn.field_70163_u + 0.2, playerIn.field_70161_v);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Green) + "Use in water to unleash some quickly growing slime creatures.");
    }
}
