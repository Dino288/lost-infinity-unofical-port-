...
extends Item {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!worldIn.field_72995_K && worldIn.field_73011_w.func_186058_p() == DimensionInit.shadowSea) {
            ...
            levi.func_70634_a(playerIn.field_70165_t, playerIn.field_70163_u - 50.0, playerIn.field_70161_v);
            levi.func_70624_b((LivingEntity)playerIn);
            levi.setLeviathanSize(5);
            worldIn.func_72838_d((Entity)levi);
            CustomParticleConfig config1 = new CustomParticleConfig();
            config1.createInstance().setParticle(ParticleInit.TESLA_RING_BLUE).setSpread(1.0, 1.0, 1.0).setCount(5).setIgnoreRange(true);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Release a shockwave when used in the Shadow Sea.");
    }
}
