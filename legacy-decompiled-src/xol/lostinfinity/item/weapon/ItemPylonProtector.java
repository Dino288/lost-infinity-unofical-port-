...
public class ItemPylonProtector
...
implements ICustomRaytrace {
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Summons a Pylon of Protection where you aim.");
        tooltip.add((Object)((Object)TextFmt.Green) + "Pylons destroy projectiles that are not fired by you.");
    }
}
