...
public class ItemAcidicConcoction
extends ItemCooldown {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if (!this.showDurabilityBar(stack)) {
            if (!worldIn.field_72995_K) {
                EntityAcidicConcoction shot = new EntityAcidicConcoction(worldIn, (LivingEntity)playerIn);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Throws flasks that release acidic gel.");
        tooltip.add((Object)((Object)TextFmt.Green) + "Acidic Gel deals damage and releases poisonous bubbles.");
        tooltip.add((Object)((Object)TextFmt.Yellow) + "Flask explosion gives nearby enemies Ultraheavy III.");
    }
}
