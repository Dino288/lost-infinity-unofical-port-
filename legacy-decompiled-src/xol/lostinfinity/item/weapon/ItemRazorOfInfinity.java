...
public class ItemRazorOfInfinity
extends Item
implements ISwitchModels {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if ((mode = stack.func_77978_p().func_74762_e("empty_data")) == 0) {
            if (!worldIn.field_72995_K) {
                EntityRecursor shot = new EntityRecursor(worldIn, (LivingEntity)playerIn);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Aqua) + "Throws out a returning disc.");
        tooltip.add((Object)((Object)TextFmt.Red) + "Deals 100% Max Health True Damage");
