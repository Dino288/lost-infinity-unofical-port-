...
implements ISummon {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level world, Player player, InteractionHand hand) {
        ...
        if (!this.showDurabilityBar(stack)) {
            if (!world.field_72995_K) {
                ...
                andromeda.func_70107_b(player.field_70165_t, player.field_70163_u + 60.0, player.field_70161_v);
                world.func_72838_d((Entity)andromeda);
                world.func_184133_a(null, player.func_180425_c(), SoundInit.MAGIC_WEAPON_18, SoundSource.PLAYERS, 0.7f, 0.6f);
            }
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Dark_Red) + "What have you done...");
        tooltip.add((Object)((Object)TextFmt.Gold) + "Creates a giant metal serpent known as the Andromeda");
    }
}
