...
public class ItemFractureOfTheCosmos
...
ICustomRaytrace {
        ...
        if (!this.showDurabilityBar(stack)) {
            if (!worldIn.field_72995_K) {
                ...
                for (int i = 0; i < 5; ++i) {
                    ...
                    bomb.setTimer(0);
                    bomb.setDir(dir.func_178785_b((float)(-3 * i) + worldIn.field_73012_v.nextFloat() * 6.0f * (float)i));
                    bomb.setRepeats(50);
                    worldIn.func_72838_d((Entity)bomb);
                }
                worldIn.func_184133_a(null, playerIn.func_180425_c(), SoundInit.DEEP_EXPLOSION, SoundSource.PLAYERS, 2.0f, 0.7f);
            }
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Light_Purple) + "Creates several Cosmic Quakes along the ground.");
        tooltip.add((Object)((Object)TextFmt.Aqua) + "One quake's direction is the direction you are facing.");
        tooltip.add((Object)((Object)TextFmt.Gold) + "Deals 200% Health As True Damage");
    }
}
