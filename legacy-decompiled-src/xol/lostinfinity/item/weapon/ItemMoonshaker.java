...
implements ICustomRaytrace {
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Summons a Totems of the Moon where you aim.");
        tooltip.add((Object)((Object)TextFmt.Green) + "Totems fire waves of bombs in a ring around it.");
    }
}
