...
public class ItemStarStorm
extends ItemCooldown {
    public ItemStarStorm(String regName) {
        super(regName);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Yellow) + "Fires a projectile that creates a bunch of falling stars.");
        tooltip.add((Object)((Object)TextFmt.Red) + "Stars deal 33% max health each.");
    }
}
