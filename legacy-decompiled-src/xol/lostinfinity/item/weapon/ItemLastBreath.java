...
implements IMaxAttack {
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Deals 50% max health damage per hit.");
        tooltip.add((Object)((Object)TextFmt.Red) + "Deals up to 300% increased damage depending on your missing health.");
