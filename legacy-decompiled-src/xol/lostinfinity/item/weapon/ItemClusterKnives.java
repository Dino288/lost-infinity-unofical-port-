...
public class ItemClusterKnives
extends ItemCooldown {
        ...
        if (!this.showDurabilityBar(playerIn.func_184586_b(handIn))) {
            if (!worldIn.field_72995_K) {
                for (int i = 0; i < 6; ++i) {
                    ...
                    shot.func_184538_a((Entity)playerIn, playerIn.field_70125_A, playerIn.field_70177_z, 0.0f, 2.0f, 7.0f);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Fires 6 galaxy knives at once, with a random assortment of each.");
        tooltip.add((Object)((Object)TextFmt.Red) + "These galaxy knives deal double damage.");
    }
}
