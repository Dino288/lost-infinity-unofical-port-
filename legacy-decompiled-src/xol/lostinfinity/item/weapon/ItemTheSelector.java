...
ICustomHoldPose {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if (!this.showDurabilityBar(stack)) {
            ...
            if (!worldIn.field_72995_K && (trace_result = this.standardFXTrace(worldIn, (LivingEntity)playerIn, 100, EnumParticleTypes.SMOKE_NORMAL, LivingEntity.class)) != null && trace_result.getResultEntity() != null && !(hit_name = (target = (LivingEntity)trace_result.getResultEntity()).func_70005_c_().toLowerCase()).isEmpty() && ItemTheSelector.regexMatch(stack.func_77978_p().func_74762_e("characters_data"), hit_name.substring(0, 1))) {
                boolean foundNear = false;
                for (LivingEntity entity : worldIn.func_72872_a(LivingEntity.class, new AABB(target.func_180425_c()).func_72314_b(10.0, 10.0, 10.0))) {
                    String entity_name;
                    if (entity.func_110124_au().equals(target.func_110124_au()) || (entity_name = entity.func_70005_c_().toLowerCase()).isEmpty() || !ItemTheSelector.regexMatch(stack.func_77978_p().func_74762_e("characters_data"), hit_name.substring(0, 1))) continue;
                ...
                if (!foundNear) {
                    IMaxAttack.dealTrueDamage((Entity)playerIn, target, target.func_110138_aP() * 0.75f);
                }
            }
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add((Object)((Object)TextFmt.Green) + "Can spread to nearby entity with the same letter group.");
        tooltip.add((Object)((Object)TextFmt.Gold) + "Single-Hit: Deals 75% Health True Damage");
        tooltip.add((Object)((Object)TextFmt.Gold) + "Multi-Hit: Deals 25% Health True Damage");
        tooltip.add((Object)((Object)TextFmt.Underline) + "Also removes 4 lives from creatures with multiple lives.");
    }
