...
implements ICustomHoldPose {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!this.showDurabilityBar(playerIn.func_184586_b(handIn))) {
            if (!worldIn.field_72995_K) {
                for (int i = 0; i < 8; ++i) {
                    EntityTekBullet shot = new EntityTekBullet(worldIn, (LivingEntity)playerIn);
                    shot.setThrower((LivingEntity)playerIn);
                    shot.func_184538_a((Entity)playerIn, playerIn.field_70125_A, playerIn.field_70177_z, 0.0f, 2.0f, 10.0f);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Shoots a bunch of bullets that deal 20% max health damage each.");
        tooltip.add((Object)((Object)TextFmt.Italic) + "Tek Bullets remove a random active potion on targets.");
    }
}
