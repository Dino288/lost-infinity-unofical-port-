    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if (!this.showDurabilityBar(stack)) {
            if (!worldIn.field_72995_K) {
                ...
                if (trace_result != null && (result_block = worldIn.func_180495_p(pos = new BlockPos(trace_result.getGrabbedVector())).func_177230_c()) instanceof ITargetable) {
                    ((ITargetable)result_block).targetedResult(worldIn, playerIn, pos);
                }
            }
