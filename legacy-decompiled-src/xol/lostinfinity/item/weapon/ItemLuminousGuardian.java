...
public class ItemLuminousGuardian
...
implements ISummon {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level world, Player player, InteractionHand hand) {
        ...
        if (!this.showDurabilityBar(stack)) {
            if (!world.field_72995_K) {
                ...
                world.func_184133_a(null, player.func_180425_c(), SoundInit.MAGIC_WEAPON_21, SoundSource.PLAYERS, 0.7f, 0.7f + world.field_73012_v.nextFloat() * 0.6f);
            }
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Dark_Purple) + "Summons a Luminous Guardian to fight alongside you.");
        tooltip.add((Object)((Object)TextFmt.Red) + "Guardian fires beams that deal 35% Health True Damage");
    }
}
