...
public class ItemInkGun
extends ItemCooldown
implements ICustomHoldPose {
    public ItemInkGun(String regName) {
        super(regName);
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if (!this.showDurabilityBar(stack)) {
            if (!worldIn.field_72995_K) {
                ...
                worldIn.func_184133_a(null, playerIn.func_180425_c(), SoundInit.PAINT_GUN, SoundSource.PLAYERS, 1.0f, 0.9f + worldIn.field_73012_v.nextFloat() * 0.4f);
            }
