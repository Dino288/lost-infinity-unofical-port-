...
public class ItemTNTStrapper
extends ItemCooldown {
    public ItemTNTStrapper(String regName) {
        super(regName);
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!this.showDurabilityBar(playerIn.func_184586_b(handIn))) {
            if (!worldIn.field_72995_K) {
                EntityTNTStrapper shot = new EntityTNTStrapper(worldIn, (LivingEntity)playerIn);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Gold) + "Shoots a projectile that summons a TNT Zombie where it lands.");
    }
}
