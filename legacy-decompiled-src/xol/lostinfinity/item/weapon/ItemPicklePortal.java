...
implements ICustomRaytrace {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!this.showDurabilityBar(playerIn.func_184586_b(handIn))) {
            ...
            if (!worldIn.field_72995_K && (trace_result = this.forwardTrace(worldIn, (Entity)playerIn, 10)) != null) {
                ...
                worldIn.func_184133_a(null, resultPos, SoundInit.PICKLE_PORTAL, SoundSource.PLAYERS, 1.0f, 1.0f);
            }
            worldIn.func_184133_a(null, playerIn.func_180425_c(), SoundInit.PICKLE_PORTAL, SoundSource.PLAYERS, 1.0f, 1.0f);
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Aqua) + "Opens pickle portals.");
        tooltip.add((Object)((Object)TextFmt.Gold) + "Summons an army of picklemen to fight for you.");
    }
}
