...
IMaxAttack {
    ...
    public InteractionResultHolder<ItemStack> func_77659_a(Level worldIn, Player playerIn, InteractionHand handIn) {
        if (!this.showDurabilityBar(playerIn.func_184586_b(handIn))) {
            ...
            if (!worldIn.field_72995_K && (trace_result = this.forcedDistanceTrace(worldIn, (Entity)playerIn, 75)) != null) {
                ...
                worldIn.func_72838_d((Entity)rift);
                ...
                for (LivingEntity near_pl : worldIn.func_72872_a(LivingEntity.class, playerIn.func_174813_aQ().func_72314_b(10.0, 10.0, 10.0))) {
    ...
    public void func_77624_a(ItemStack stack, @Nullable Level worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add((Object)((Object)TextFmt.Aqua) + "Can be used to quickly warp fowards.");
        tooltip.add((Object)((Object)TextFmt.Italic) + "Warping also curses enemies with vulnerability IV.");
        tooltip.add((Object)((Object)TextFmt.Gold) + "Leaves Unstable Rifts where you teleport from.");
        tooltip.add((Object)((Object)TextFmt.Red) + "After a few seconds, rifts explode.");
    }
}
