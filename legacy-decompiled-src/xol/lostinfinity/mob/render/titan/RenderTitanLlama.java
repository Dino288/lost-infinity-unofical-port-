...
public class RenderTitanLlama
extends RenderLiving<EntityTitanLlama> {
    ...
    protected void preRenderCallback(EntityTitanLlama entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)this.scale, (float)this.scale, (float)this.scale);
    }

    protected ResourceLocation getEntityTexture(EntityTitanLlama entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityTitanLlama entityLiving, float p1, float rotationYaw, float partialTicks) {
