...
public class RenderTitanShulker
extends RenderLiving<EntityTitanShulker> {
    ...
    protected void preRenderCallback(EntityTitanShulker entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)this.scale, (float)this.scale, (float)this.scale);
    }

    protected ResourceLocation getEntityTexture(EntityTitanShulker entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityTitanShulker entityLiving, float p1, float rotationYaw, float partialTicks) {
