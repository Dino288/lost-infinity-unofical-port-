...
public class RenderTitanBlaze
extends RenderLiving<EntityTitanBlaze> {
    ...
    protected void preRenderCallback(EntityTitanBlaze entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)this.scale, (float)this.scale, (float)this.scale);
    }

    protected ResourceLocation getEntityTexture(EntityTitanBlaze entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityTitanBlaze entityLiving, float p1, float rotationYaw, float partialTicks) {
