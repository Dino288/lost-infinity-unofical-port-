...
public class RenderClinger
extends RenderLiving<EntityClinger> {
    ...
    public RenderClinger(RenderManager manager) {
        super(manager, (ModelBase)new ModelClinger(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityClinger entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityClinger entityLiving, float p1, float rotationYaw, float partialTicks) {
