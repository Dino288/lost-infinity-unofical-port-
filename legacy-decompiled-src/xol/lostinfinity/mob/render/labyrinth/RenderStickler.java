...
public class RenderStickler
extends RenderLiving<EntityStickler> {
    ...
    public RenderStickler(RenderManager manager) {
        super(manager, (ModelBase)new ModelStickler(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityStickler entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityStickler entityLiving, float p1, float rotationYaw, float partialTicks) {
