...
public class RenderCyclos
extends RenderLiving<EntityCyclos> {
    ...
    public RenderCyclos(RenderManager manager) {
        super(manager, (ModelBase)new ModelCyclos(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityCyclos entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityCyclos entityLiving, float p1, float rotationYaw, float partialTicks) {
