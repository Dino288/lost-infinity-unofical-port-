...
public class RenderOperatorHolodeck
extends RenderLiving<EntityOperatorHolodeck> {
    ...
    protected void applyRotations(EntityOperatorHolodeck entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityOperatorHolodeck entity) {
        return TEXTURES;
    }
}
