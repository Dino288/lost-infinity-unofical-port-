...
public class RenderOperatorHunters
extends RenderLiving<EntityOperatorHunters> {
    ...
    protected void applyRotations(EntityOperatorHunters entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityOperatorHunters entity) {
        return TEXTURES;
    }
}
