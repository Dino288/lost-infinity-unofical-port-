...
public class RenderOperatorRedlight
extends RenderLiving<EntityOperatorRedlight> {
    ...
    protected void applyRotations(EntityOperatorRedlight entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityOperatorRedlight entity) {
        return TEXTURES;
    }
}
