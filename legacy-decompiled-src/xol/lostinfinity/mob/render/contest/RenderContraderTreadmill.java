...
public class RenderContraderTreadmill
extends RenderLiving<EntityContraderTreadmill> {
    ...
    protected void applyRotations(EntityContraderTreadmill entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityContraderTreadmill entity) {
        return TEXTURES;
    }
}
