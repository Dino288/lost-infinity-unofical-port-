...
public class RenderOperatorTrampolineDodgeball
extends RenderLiving<EntityOperatorTrampolineDodgeball> {
    ...
    protected void applyRotations(EntityOperatorTrampolineDodgeball entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityOperatorTrampolineDodgeball entity) {
        return TEXTURES;
    }
}
