...
public class RenderContraderMarket
extends RenderLiving<EntityContraderMarket> {
    ...
    protected void applyRotations(EntityContraderMarket entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityContraderMarket entity) {
        return TEXTURES;
    }
}
