...
public class RenderControllerLaserTag
extends RenderLiving<EntityControllerLaserTag> {
    ...
    protected void preRenderCallback(EntityControllerLaserTag entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)9.0f, (float)9.0f, (float)9.0f);
    }

    protected void applyRotations(EntityControllerLaserTag entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityControllerLaserTag entity) {
        return TEXTURES;
    }
}
