...
public class RenderArcheologist
extends RenderLiving<EntityArcheologist> {
    ...
    public RenderArcheologist(RenderManager manager) {
        super(manager, (ModelBase)new ModelArcheologist(), 1.0f);
    }

    protected void applyRotations(EntityArcheologist entityLiving, float p1, float rotationYaw, float partialTicks) {
