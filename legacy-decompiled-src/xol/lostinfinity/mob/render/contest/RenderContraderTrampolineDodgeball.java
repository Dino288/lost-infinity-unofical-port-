...
public class RenderContraderTrampolineDodgeball
extends RenderLiving<EntityContraderTrampolineDodgeball> {
    ...
    protected void applyRotations(EntityContraderTrampolineDodgeball entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityContraderTrampolineDodgeball entity) {
        return TEXTURES;
    }
}
