...
public class RenderOperatorLightBridge
extends RenderLiving<EntityOperatorLightBridge> {
    ...
    protected void applyRotations(EntityOperatorLightBridge entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityOperatorLightBridge entity) {
        return TEXTURES;
    }
}
