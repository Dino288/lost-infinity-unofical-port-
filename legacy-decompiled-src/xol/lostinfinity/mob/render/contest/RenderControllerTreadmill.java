...
public class RenderControllerTreadmill
extends RenderLiving<EntityControllerTreadmill> {
    ...
    protected void preRenderCallback(EntityControllerTreadmill entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)9.0f, (float)9.0f, (float)9.0f);
    }

    protected void applyRotations(EntityControllerTreadmill entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityControllerTreadmill entity) {
        return TEXTURES;
    }
}
