...
public class RenderOperatorTargets
extends RenderLiving<EntityOperatorTargets> {
    ...
    protected void applyRotations(EntityOperatorTargets entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityOperatorTargets entity) {
        return TEXTURES;
    }
}
