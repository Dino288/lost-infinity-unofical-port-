...
public class RenderContraderHunters
extends RenderLiving<EntityContraderHunters> {
    ...
    protected void applyRotations(EntityContraderHunters entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityContraderHunters entity) {
        return TEXTURES;
    }
}
