...
public class RenderContraderBombers
extends RenderLiving<EntityContraderBombers> {
    ...
    protected void applyRotations(EntityContraderBombers entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a((LivingEntity)entityLiving, p1, rotationYaw, partialTicks);
    }

    protected ResourceLocation getEntityTexture(EntityContraderBombers entity) {
        return TEXTURES;
    }
}
