...
public class RenderSkyre
extends RenderLiving<EntitySkyre> {
    ...
    public RenderSkyre(RenderManager manager) {
        super(manager, (ModelBase)new ModelSkyre(), 0.5f);
    }

    protected void preRenderCallback(EntitySkyre entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)3.0f, (float)3.0f, (float)3.0f);
    }

    protected ResourceLocation getEntityTexture(EntitySkyre entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntitySkyre entityLiving, float p1, float rotationYaw, float partialTicks) {
