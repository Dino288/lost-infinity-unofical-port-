...
public class RenderWhisper
extends RenderLiving<EntityWhisper> {
    ...
    public RenderWhisper(RenderManager manager) {
        super(manager, (ModelBase)new ModelWhisper(), 0.5f);
    }

    protected void preRenderCallback(EntityWhisper entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)3.0f, (float)3.0f, (float)3.0f);
    }

    protected ResourceLocation getEntityTexture(EntityWhisper entity) {
    ...
    protected void applyRotations(EntityWhisper entityLiving, float p1, float rotationYaw, float partialTicks) {
