...
public class RenderAtlasCrystal
extends RenderLiving<EntityAtlasCrystal> {
    ...
    protected void preRenderCallback(EntityAtlasCrystal entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)3.0f, (float)3.0f, (float)3.0f);
    }

    protected ResourceLocation getEntityTexture(EntityAtlasCrystal entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityAtlasCrystal entityLiving, float p1, float rotationYaw, float partialTicks) {
