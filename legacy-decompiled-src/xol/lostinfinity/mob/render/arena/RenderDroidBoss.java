...
public class RenderDroidBoss
extends RenderLiving<EntityDroidBoss> {
    ...
    protected void preRenderCallback(EntityDroidBoss entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)this.scale, (float)this.scale, (float)this.scale);
    }

    protected ResourceLocation getEntityTexture(EntityDroidBoss entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityDroidBoss entityLiving, float p1, float rotationYaw, float partialTicks) {
