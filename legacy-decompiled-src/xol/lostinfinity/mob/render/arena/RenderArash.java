...
public class RenderArash
extends RenderLiving<EntityArash> {
    ...
    public RenderArash(RenderManager manager) {
        super(manager, (ModelBase)new ModelArash(), 0.5f);
    }

    protected void preRenderCallback(EntityArash entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)1.5f, (float)1.5f, (float)1.5f);
    }

    protected ResourceLocation getEntityTexture(EntityArash entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityArash entityLiving, float p1, float rotationYaw, float partialTicks) {
