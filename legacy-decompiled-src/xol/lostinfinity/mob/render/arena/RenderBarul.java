...
public class RenderBarul
extends RenderLiving<EntityBarul> {
    ...
    public RenderBarul(RenderManager manager) {
        super(manager, (ModelBase)new ModelBarul(), 0.5f);
    }

    protected void preRenderCallback(EntityBarul entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)3.0f, (float)3.0f, (float)3.0f);
    }

    protected ResourceLocation getEntityTexture(EntityBarul entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityBarul entityLiving, float p1, float rotationYaw, float partialTicks) {
