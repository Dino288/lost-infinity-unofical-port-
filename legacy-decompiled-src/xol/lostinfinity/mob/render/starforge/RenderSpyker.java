...
public class RenderSpyker
extends RenderLiving<EntitySpyker> {
    ...
    public RenderSpyker(RenderManager manager) {
        super(manager, (ModelBase)new ModelSpyker(), 0.5f);
    }

    protected void preRenderCallback(EntitySpyker entitylivingbaseIn, float partialTickTime) {
    ...
    protected ResourceLocation getEntityTexture(EntitySpyker entity) {
    ...
    protected void applyRotations(EntitySpyker entityLiving, float p1, float rotationYaw, float partialTicks) {
