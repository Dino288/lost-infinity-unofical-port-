...
public class RenderPhaser
extends RenderLiving<EntityPhaser> {
    ...
    public RenderPhaser(RenderManager manager) {
        super(manager, (ModelBase)new ModelPhaser(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityPhaser entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityPhaser entityLiving, float p1, float rotationYaw, float partialTicks) {
