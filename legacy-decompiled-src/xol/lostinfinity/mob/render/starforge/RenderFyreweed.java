...
public class RenderFyreweed
extends RenderLiving<EntityFyreweed> {
    ...
    public RenderFyreweed(RenderManager manager) {
        super(manager, (ModelBase)new ModelFyreweed(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityFyreweed entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityFyreweed entityLiving, float p1, float rotationYaw, float partialTicks) {
