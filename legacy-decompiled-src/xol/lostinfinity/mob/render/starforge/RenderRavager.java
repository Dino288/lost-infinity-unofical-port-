...
public class RenderRavager
extends RenderLiving<EntityRavager> {
    ...
    public RenderRavager(RenderManager manager) {
        super(manager, (ModelBase)new ModelRavager(), 0.5f);
    }
    ...
    protected void applyRotations(EntityRavager entityLiving, float p1, float rotationYaw, float partialTicks) {
