...
public class RenderTentaclon
extends RenderLiving<EntityTentaclon> {
    ...
    public RenderTentaclon(RenderManager manager) {
        super(manager, (ModelBase)new ModelTentaclon(), 0.5f);
    }

    protected void preRenderCallback(EntityTentaclon entity, float partialTickTime) {
    ...
    protected ResourceLocation getEntityTexture(EntityTentaclon entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityTentaclon entityLiving, float p1, float rotationYaw, float partialTicks) {
