...
public class RenderSnapper
extends RenderLiving<EntitySnapper> {
    ...
    public RenderSnapper(RenderManager manager) {
        super(manager, (ModelBase)new ModelSnapper(), 0.5f);
    }
    ...
    protected void applyRotations(EntitySnapper entityLiving, float p1, float rotationYaw, float partialTicks) {
