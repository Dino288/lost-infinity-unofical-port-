...
public class RenderChomper
extends RenderLiving<EntityChomper> {
    ...
    public RenderChomper(RenderManager manager) {
        super(manager, (ModelBase)new ModelChomper(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityChomper entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityChomper entityLiving, float p1, float rotationYaw, float partialTicks) {
