...
public class RenderAcidback
extends RenderLiving<EntityAcidback> {
    ...
    public RenderAcidback(RenderManager manager) {
        super(manager, (ModelBase)new ModelAcidback(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityAcidback entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityAcidback entityLiving, float p1, float rotationYaw, float partialTicks) {
