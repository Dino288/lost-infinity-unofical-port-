...
public class RenderHanger
extends RenderLiving<EntityHanger> {
    ...
    public RenderHanger(RenderManager manager) {
        super(manager, (ModelBase)new ModelHanger(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityHanger entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityHanger entityLiving, float p1, float rotationYaw, float partialTicks) {
