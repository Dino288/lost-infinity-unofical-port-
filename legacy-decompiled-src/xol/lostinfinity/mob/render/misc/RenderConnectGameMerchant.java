...
public class RenderConnectGameMerchant
extends RenderLiving<EntityConnectGameMerchant> {
    ...
    protected ResourceLocation getEntityTexture(EntityConnectGameMerchant entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityConnectGameMerchant entityLiving, float p1, float rotationYaw, float partialTicks) {
