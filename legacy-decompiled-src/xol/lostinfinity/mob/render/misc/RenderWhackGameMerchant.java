...
public class RenderWhackGameMerchant
extends RenderLiving<EntityWhackGameMerchant> {
    ...
    protected ResourceLocation getEntityTexture(EntityWhackGameMerchant entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityWhackGameMerchant entityLiving, float p1, float rotationYaw, float partialTicks) {
