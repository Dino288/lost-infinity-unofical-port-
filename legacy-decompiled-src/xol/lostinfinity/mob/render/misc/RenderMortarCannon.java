...
public class RenderMortarCannon
extends RenderLiving<EntityMortarCannon> {
    ...
    protected ResourceLocation getEntityTexture(EntityMortarCannon entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityMortarCannon entityLiving, float p1, float rotationYaw, float partialTicks) {
