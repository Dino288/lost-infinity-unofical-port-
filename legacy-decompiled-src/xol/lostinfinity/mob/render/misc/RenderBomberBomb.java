...
public class RenderBomberBomb
extends RenderLiving<EntityBomberBomb> {
    ...
    protected void preRenderCallback(EntityBomberBomb entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)1.5f, (float)1.5f, (float)1.5f);
    }

    protected ResourceLocation getEntityTexture(EntityBomberBomb entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityBomberBomb entityLiving, float p1, float rotationYaw, float partialTicks) {
