...
public class RenderDimensionalMerchant
extends RenderLiving<EntityDimensionalMerchant> {
    ...
    protected ResourceLocation getEntityTexture(EntityDimensionalMerchant entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityDimensionalMerchant entityLiving, float p1, float rotationYaw, float partialTicks) {
