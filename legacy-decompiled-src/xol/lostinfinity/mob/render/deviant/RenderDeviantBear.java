...
public class RenderDeviantBear
extends RenderLiving<EntityDeviantBear> {
    ...
    public RenderDeviantBear(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantBear(), 0.5f);
    }

    protected void preRenderCallback(EntityDeviantBear entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)this.scale, (float)this.scale, (float)this.scale);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantBear entity) {
    ...
    protected void applyRotations(EntityDeviantBear entityLiving, float p1, float rotationYaw, float partialTicks) {
