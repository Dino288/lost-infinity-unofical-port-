...
public class RenderDeviantPig
extends RenderLiving<EntityDeviantPig> {
    ...
    public RenderDeviantPig(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantPig(), 0.5f);
    }

    protected void preRenderCallback(EntityDeviantPig entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)2.0f, (float)2.0f, (float)2.0f);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantPig entity) {
    ...
    protected void applyRotations(EntityDeviantPig entityLiving, float p1, float rotationYaw, float partialTicks) {
