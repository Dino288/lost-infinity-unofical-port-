...
public class RenderDeviantPiglin
extends RenderLiving<EntityDeviantPiglin> {
    ...
    protected void preRenderCallback(EntityDeviantPiglin entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)this.scale, (float)this.scale, (float)this.scale);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantPiglin entity) {
    ...
    protected void applyRotations(EntityDeviantPiglin entityLiving, float p1, float rotationYaw, float partialTicks) {
