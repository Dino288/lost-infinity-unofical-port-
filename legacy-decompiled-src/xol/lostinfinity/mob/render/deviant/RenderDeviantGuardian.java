...
public class RenderDeviantGuardian
extends RenderLiving<EntityDeviantGuardian> {
    ...
    public RenderDeviantGuardian(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantGuardian(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantGuardian entity) {
    ...
    protected void applyRotations(EntityDeviantGuardian entityLiving, float p1, float rotationYaw, float partialTicks) {
