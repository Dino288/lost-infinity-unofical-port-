...
public class RenderDeviantSlime
extends RenderLiving<EntityDeviantSlime> {
    ...
    public RenderDeviantSlime(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantSlime(), 0.5f);
    }

    protected void preRenderCallback(EntityDeviantSlime entitylivingbaseIn, float partialTickTime) {
    ...
    protected ResourceLocation getEntityTexture(EntityDeviantSlime entity) {
    ...
    protected void applyRotations(EntityDeviantSlime entityLiving, float p1, float rotationYaw, float partialTicks) {
