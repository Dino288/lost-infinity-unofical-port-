...
public class RenderDeviantVex
extends RenderLiving<EntityDeviantVex> {
    ...
    protected void preRenderCallback(EntityDeviantVex entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)0.75f, (float)0.75f, (float)0.75f);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantVex entity) {
    ...
    protected void applyRotations(EntityDeviantVex entityLiving, float p1, float rotationYaw, float partialTicks) {
