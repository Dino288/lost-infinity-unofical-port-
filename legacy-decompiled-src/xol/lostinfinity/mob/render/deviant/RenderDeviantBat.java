...
public class RenderDeviantBat
extends RenderLiving<EntityDeviantBat> {
    ...
    public RenderDeviantBat(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantBat(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantBat entity) {
    ...
    protected void applyRotations(EntityDeviantBat entityLiving, float p1, float rotationYaw, float partialTicks) {
