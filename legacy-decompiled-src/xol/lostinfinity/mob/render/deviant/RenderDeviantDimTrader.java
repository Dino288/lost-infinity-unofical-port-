...
public class RenderDeviantDimTrader
extends RenderLiving<EntityDeviantDimTrader> {
    ...
    public RenderDeviantDimTrader(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantDimTrader(), 0.5f);
    }

    protected void preRenderCallback(EntityDeviantDimTrader entitylivingbaseIn, float partialTickTime) {
    ...
    protected ResourceLocation getEntityTexture(EntityDeviantDimTrader entity) {
    ...
    protected void applyRotations(EntityDeviantDimTrader entityLiving, float p1, float rotationYaw, float partialTicks) {
