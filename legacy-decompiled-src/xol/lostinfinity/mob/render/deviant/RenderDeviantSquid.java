...
public class RenderDeviantSquid
extends RenderLiving<EntityDeviantSquid> {
    ...
    public RenderDeviantSquid(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantSquid(), 0.5f);
    }

    protected void preRenderCallback(EntityDeviantSquid entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)2.0f, (float)2.0f, (float)2.0f);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantSquid entity) {
    ...
    protected void applyRotations(EntityDeviantSquid entityLiving, float p1, float rotationYaw, float partialTicks) {
