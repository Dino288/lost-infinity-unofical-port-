...
public class RenderLostDeviant
extends RenderLiving<EntityLostDeviant> {
    ...
    public RenderLostDeviant(RenderManager manager) {
        super(manager, (ModelBase)new ModelLostDeviant(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityLostDeviant entity) {
        return TEXTURES;
    }

    protected void applyRotations(EntityLostDeviant entityLiving, float p1, float rotationYaw, float partialTicks) {
