...
public class RenderDeviantShulker
extends RenderLiving<EntityDeviantShulker> {
    ...
    public RenderDeviantShulker(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantShulker(), 0.5f);
    }

    protected void preRenderCallback(EntityDeviantShulker entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)this.scale, (float)this.scale, (float)this.scale);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantShulker entity) {
    ...
    protected void applyRotations(EntityDeviantShulker entityLiving, float p1, float rotationYaw, float partialTicks) {
