...
public class RenderDeviantMooshroom
extends RenderLiving<EntityDeviantMooshroom> {
    ...
    public RenderDeviantMooshroom(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantMooshroom(), 0.5f);
    }

    protected void preRenderCallback(EntityDeviantMooshroom entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)this.scale, (float)this.scale, (float)this.scale);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantMooshroom entity) {
    ...
    protected void applyRotations(EntityDeviantMooshroom entityLiving, float p1, float rotationYaw, float partialTicks) {
