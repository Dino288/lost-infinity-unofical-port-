...
public class RenderDeviantSheep
extends RenderLiving<EntityDeviantSheep> {
    ...
    public RenderDeviantSheep(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantSheep(), 0.5f);
    }

    protected void preRenderCallback(EntityDeviantSheep entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)this.scale, (float)this.scale, (float)this.scale);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantSheep entity) {
    ...
    protected void applyRotations(EntityDeviantSheep entityLiving, float p1, float rotationYaw, float partialTicks) {
