...
public class RenderDeviantCaveSpider
extends RenderLiving<EntityDeviantCaveSpider> {
    ...
    public RenderDeviantCaveSpider(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantCaveSpider(), 0.5f);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantCaveSpider entity) {
    ...
    protected void applyRotations(EntityDeviantCaveSpider entityLiving, float p1, float rotationYaw, float partialTicks) {
