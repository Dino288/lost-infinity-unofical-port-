...
public class RenderDeviantWitch
extends RenderLiving<EntityDeviantWitch> {
    ...
    public RenderDeviantWitch(RenderManager manager) {
        super(manager, (ModelBase)new ModelDeviantWitch(), 0.5f);
    }

    protected void preRenderCallback(EntityDeviantWitch entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a((float)1.5f, (float)1.5f, (float)1.5f);
    }

    protected ResourceLocation getEntityTexture(EntityDeviantWitch entity) {
    ...
    protected void applyRotations(EntityDeviantWitch entityLiving, float p1, float rotationYaw, float partialTicks) {
