...
extends ModelBase {
    ...
    public ModelTNTZombie() {
        ...
        this.setRotationAngle(this.Body_r2, -1.309f, 0.0f, 0.0f);
    ...
    public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.RightArm.field_78795_f = -((float)(1.5707963267948966 + (double)(Mth.func_76134_b((float)(ageInTicks * 0.1f)) * (float)Math.PI * 0.15f)));
        this.LeftArm.field_78795_f = -((float)(1.5707963267948966 + (double)(Mth.func_76134_b((float)((ageInTicks + 100.0f) * 0.1f)) * (float)Math.PI * 0.15f)));
