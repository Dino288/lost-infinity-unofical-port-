...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ModelRenderer modelRenderer = this.getModelRenderer(entity);
    ...
    public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (modelRenderer == this.BodyFin) {
            this.FinLeft.field_78796_g = (float)Mth.func_151238_b((double)-0.5235987901687622, (double)-1.3962633609771729, (double)LMath.trig01(Mth.func_76126_a((float)(ageInTicks / 10.0f))));
            this.FinRight.field_78796_g = -this.FinLeft.field_78796_g;
        } else if (modelRenderer == this.Head) {
            if (((EntitySeaSerpentController)segment.getRelay()).getAnimation() == 1) {
