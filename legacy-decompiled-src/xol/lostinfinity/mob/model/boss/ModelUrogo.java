...
extends ModelBase {
    ...
    public ModelUrogo() {
        ...
        this.sword3 = new ModelRenderer((ModelBase)this, 89, 29);
        ...
        this.sword2 = new ModelRenderer((ModelBase)this, 95, 16);
        this.sword2.func_78793_a(-9.0f, 0.0f, 0.0f);
        this.sword2.func_78790_a(-2.5f, 8.0f, -8.0f, 3, 8, 2, 0.0f);
        this.sword5 = new ModelRenderer((ModelBase)this, 89, 51);
        ...
        this.sword4 = new ModelRenderer((ModelBase)this, 89, 41);
    ...
    public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.sword1.field_78795_f = Mth.func_76134_b((float)(limbSwing * 0.6662f + (float)Math.PI)) * 2.0f * limbSwingAmount * 0.5f;
        this.sword2.field_78795_f = Mth.func_76134_b((float)(limbSwing * 0.6662f + (float)Math.PI)) * 2.0f * limbSwingAmount * 0.5f;
        this.sword3.field_78795_f = Mth.func_76134_b((float)(limbSwing * 0.6662f + (float)Math.PI)) * 2.0f * limbSwingAmount * 0.5f;
        this.sword4.field_78795_f = Mth.func_76134_b((float)(limbSwing * 0.6662f + (float)Math.PI)) * 2.0f * limbSwingAmount * 0.5f;
        this.sword5.field_78795_f = Mth.func_76134_b((float)(limbSwing * 0.6662f + (float)Math.PI)) * 2.0f * limbSwingAmount * 0.5f;
    }
}
