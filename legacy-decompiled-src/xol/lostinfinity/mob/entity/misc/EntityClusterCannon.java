...
public class EntityClusterCannon
extends EntityBaseCannon {
    public EntityClusterCannon(Level worldIn) {
        super(worldIn);
    }
    ...
    public void func_70636_d() {
        super.func_70636_d();
        if (!this.field_70170_p.field_72995_K && this.field_70173_aa % 7 == 0) {
            EntityBlightBomb shot = new EntityBlightBomb(this.field_70170_p, (LivingEntity)this);
