...
public class EntityNebulaGrunt
extends EntityFloatingBase
implements IMaxAttack {
    private float modelAlpha = 0.0f;
    private static final DataParameter<Optional<BlockPos>> HOME_POS = EntityDataManager.func_187226_a(EntityNebulaGrunt.class, (DataSerializer)DataSerializers.field_187201_k);

    public EntityNebulaGrunt(Level worldIn) {
        super(worldIn);
        this.func_70105_a(2.1f, 2.5f);
        this.field_70765_h = new AIMoveControl((Mob)this);
        this.field_70145_X = true;
    }

    public EntityNebulaGrunt(Level worldIn, BlockPos parentBlock) {
        super(worldIn);
        this.func_70105_a(2.1f, 2.5f);
    ...
    public void func_70636_d() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            if (this.func_70638_az() != null && this.func_70032_d((Entity)this.func_70638_az()) <= 3.0f) {
    ...
    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        return SoundInit.NEBULA_GRUNT_HURT;
    }

    protected SoundEvent func_184639_G() {
        return SoundInit.NEBULA_GRUNT_AMBIENT;
    }

    protected SoundEvent func_184615_bR() {
        return SoundInit.NEBULA_GRUNT_DEATH;
    }
