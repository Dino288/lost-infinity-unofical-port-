...
public class EntityNebulaGiant
extends EntityFloatingBase
implements IMaxAttack {
    private float modelAlpha = 0.0f;
    private static final DataParameter<Optional<BlockPos>> HOME_POS = EntityDataManager.func_187226_a(EntityNebulaGiant.class, (DataSerializer)DataSerializers.field_187201_k);
    private static final double EXPLOSION_RANGE = 5.0;

    public EntityNebulaGiant(Level worldIn) {
        super(worldIn);
        this.func_70105_a(4.3f, 2.3f);
        this.field_70765_h = new AIMoveControl((Mob)this);
        this.field_70145_X = true;
    }

    public EntityNebulaGiant(Level worldIn, BlockPos parentBlock) {
        super(worldIn);
        this.func_70105_a(4.3f, 2.3f);
    ...
    public void func_70636_d() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            if (this.field_70173_aa % 100 == 0) {
                this.field_70170_p.func_184133_a(null, this.func_180425_c(), SoundInit.NEBULA_GIANT_SHOCKWAVE, SoundSource.HOSTILE, 1.5f, 0.8f + this.field_70146_Z.nextFloat() * 0.4f);
                ...
                IParticleSpawner.spawnParticle(this.field_70170_p, 23, 0, this.field_70165_t, this.field_70163_u + (double)(this.field_70131_O / 2.0f), this.field_70161_v);
                List list = this.field_70170_p.func_72872_a(Player.class, this.func_174813_aQ().func_186662_g(5.0));
                for (Player player : list) {
                    player.func_70690_d(new PotionEffect(PotionInit.LAST_BREATH, 100));
                    player.func_70690_d(new PotionEffect(PotionInit.SHATTERED, 100));
