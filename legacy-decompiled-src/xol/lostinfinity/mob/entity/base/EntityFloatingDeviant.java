...
import xol.lostinfinity.mob.entity.base.EntityFlyingDeviant;

public abstract class EntityFloatingDeviant
extends EntityFlyingDeviant
implements IMob {
    protected int attackCooldown = 0;
    protected int attackGracePeriod = 15;
    private static DataParameter<Optional<UUID>> TargetData = EntityDataManager.func_187226_a(EntityFloatingDeviant.class, (DataSerializer)DataSerializers.field_187203_m);

    public EntityFloatingDeviant(Level worldIn) {
        super(worldIn);
        this.field_70765_h = new FloatMoveHelper((Mob)this);
    }
