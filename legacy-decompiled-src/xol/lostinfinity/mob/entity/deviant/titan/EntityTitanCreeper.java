...
public class EntityTitanCreeper
extends EntityDeviantTitan {
    private boolean animationState = false;
    private boolean cageVisible = false;

    public EntityTitanCreeper(Level worldIn) {
        super(worldIn);
        this.func_70105_a(3.5f, 7.5f);
    }
    ...
    protected ResourceLocation func_184647_J() {
        return this.onFinalLife() ? LootTableRegistry.ENTITIES_TITAN_CREEPER : null;
    }
}
