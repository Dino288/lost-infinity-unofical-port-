...
public class EntityTitanEnderman
extends EntityDeviantTitan {
    public EntityTitanEnderman(Level worldIn) {
        super(worldIn);
        this.func_70105_a(2.5f, 11.0f);
    }
    ...
    public void func_70636_d() {
        ...
        if (this.field_70173_aa % 60 == 10) {
            ...
            this.func_70690_d(new PotionEffect(MobEffects.field_76441_p, 45));
        }
    ...
    protected ResourceLocation func_184647_J() {
        return this.onFinalLife() ? LootTableRegistry.ENTITIES_TITAN_ENDERMAN : null;
    }
}
