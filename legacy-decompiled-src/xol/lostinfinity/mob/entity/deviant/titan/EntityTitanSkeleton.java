...
public class EntityTitanSkeleton
extends EntityDeviantTitan {
    public EntityTitanSkeleton(Level worldIn) {
        super(worldIn);
        this.func_70105_a(4.0f, 8.5f);
    }
    ...
    public void func_70636_d() {
        ...
        if (this.field_70173_aa % 4 == 0 && target != null) {
    ...
    protected ResourceLocation func_184647_J() {
        return this.onFinalLife() ? LootTableRegistry.ENTITIES_TITAN_SKELETON : null;
    }
}
