...
public class EntityDeviantMagmacube
extends EntityDeviantMob
implements IMaxAttack {
    public EntityDeviantMagmacube(Level worldIn) {
        super(worldIn);
    ...
    public void func_180430_e(float distance, float damageMultiplier) {
        if (!this.field_70170_p.field_72995_K) {
            for (Player near_pl : this.field_70170_p.func_72872_a(Player.class, this.func_174813_aQ().func_72314_b(10.0, 10.0, 10.0))) {
