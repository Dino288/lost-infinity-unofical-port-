...
public class EntityDeviantChicken
extends EntityDeviantMob
implements IMaxAttack {
    public EntityDeviantChicken(Level worldIn) {
        super(worldIn);
        this.func_70105_a(1.6f, 2.0f);
    }
    ...
    protected ResourceLocation deviantDrop() {
        return LootTableRegistry.ENTITIES_DEVIANTCHICKEN;
    }

    @Override
    protected ResourceLocation superMutatedDrop() {
        return LootTableRegistry.ENTITIES_SUPERMUTANT_CHICKEN;
    }
}
