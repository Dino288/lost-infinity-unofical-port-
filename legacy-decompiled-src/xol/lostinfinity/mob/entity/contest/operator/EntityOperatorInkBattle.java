...
extends EntityOperatorBase {
    ...
    protected void startGame() {
        ...
        for (EntityControllerInkBattle entity : this.field_70170_p.func_72872_a(EntityControllerInkBattle.class, this.getArenaAABB())) {
            entity.func_70106_y();
        }
        ...
        for (UUID pl_id : this.contenders) {
            ...
            gamehologram.setInk(pl_id, curSpawn + 1);
            ...
            pl.func_145747_a((Component)new Component((Object)((Object)TextFmt.Aqua) + "Grandmaster: Alright contenders, try to ink the most blocks to your colour!"));
            ++curSpawn;
        }
