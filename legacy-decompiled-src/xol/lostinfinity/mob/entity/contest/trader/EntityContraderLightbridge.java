...
public class EntityContraderLightbridge
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderLightbridge(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaOyster, 20), new ItemStack(ItemInit.ellipticalProjector)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaOyster, 50), new ItemStack(ItemInit.zirconiaOyster, 50), new ItemStack(ItemInit.simpleMicrocontroller)));
        return list;
    }
}
