...
public class EntityContraderTreadmill
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderTreadmill(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaMythic, 20), new ItemStack(ItemInit.spaceboundAltimeter)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaMythic, 50), new ItemStack(ItemInit.zirconiaMythic, 50), new ItemStack(ItemInit.complexGyroscope)));
        return list;
    }
}
