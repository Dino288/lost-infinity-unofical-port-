...
public class EntityContraderParkour
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderParkour(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaMusky, 20), new ItemStack(ItemInit.voidBox)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaMusky, 50), new ItemStack(ItemInit.zirconiaMusky, 50), new ItemStack(ItemInit.superBooster)));
        return list;
    }
}
