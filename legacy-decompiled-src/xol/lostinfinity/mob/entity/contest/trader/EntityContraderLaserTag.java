...
public class EntityContraderLaserTag
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderLaserTag(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaMidnight, 20), new ItemStack(ItemInit.laserPointer)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaMidnight, 50), new ItemStack(ItemInit.zirconiaMidnight, 50), new ItemStack(ItemInit.rgbIlluminator)));
        return list;
    }
}
