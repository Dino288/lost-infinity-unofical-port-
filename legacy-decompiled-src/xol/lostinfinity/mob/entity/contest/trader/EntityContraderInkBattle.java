...
public class EntityContraderInkBattle
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderInkBattle(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaIvory, 20), new ItemStack(ItemInit.chromeAlumVial)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaIvory, 50), new ItemStack(ItemInit.zirconiaIvory, 50), new ItemStack(ItemInit.inkPen)));
        return list;
    }
}
