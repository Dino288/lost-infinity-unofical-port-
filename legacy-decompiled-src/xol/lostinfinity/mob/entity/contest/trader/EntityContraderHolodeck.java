...
public class EntityContraderHolodeck
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderHolodeck(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaCerulean, 20), new ItemStack(ItemInit.powerPlug)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaCerulean, 50), new ItemStack(ItemInit.zirconiaCerulean, 50), new ItemStack(ItemInit.ceruleanLens)));
        return list;
    }
}
