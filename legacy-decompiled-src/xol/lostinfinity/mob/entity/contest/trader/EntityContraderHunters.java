...
public class EntityContraderHunters
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderHunters(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaCrimson, 20), new ItemStack(ItemInit.powerFunnel)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaCrimson, 50), new ItemStack(ItemInit.zirconiaCrimson, 50), new ItemStack(ItemInit.crimsonTransducer)));
        return list;
    }
}
