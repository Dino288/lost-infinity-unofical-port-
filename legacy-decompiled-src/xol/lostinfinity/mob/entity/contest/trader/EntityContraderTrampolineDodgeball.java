...
public class EntityContraderTrampolineDodgeball
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderTrampolineDodgeball(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaAubergine, 20), new ItemStack(ItemInit.dangerousAccelerant)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaAubergine, 50), new ItemStack(ItemInit.zirconiaAubergine, 50), new ItemStack(ItemInit.energySplitter)));
        return list;
    }
}
