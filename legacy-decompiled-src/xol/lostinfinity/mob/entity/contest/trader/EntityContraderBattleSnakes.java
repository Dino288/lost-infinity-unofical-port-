...
public class EntityContraderBattleSnakes
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderBattleSnakes(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaCeladon, 20), new ItemStack(ItemInit.superInductor)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaCeladon, 50), new ItemStack(ItemInit.zirconiaCeladon, 50), new ItemStack(ItemInit.advancedRelay)));
        return list;
    }
}
