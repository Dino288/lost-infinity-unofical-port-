...
public class EntityContraderBombers
extends EntityBaseMerchant
implements INpc,
IMerchant {
    public EntityContraderBombers(Level worldIn) {
        super(worldIn);
    }
    ...
    public MerchantRecipeList getRecipeList() {
        ...
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaCitrine, 20), new ItemStack(ItemInit.citrineThyratron)));
        list.add((Object)new MerchantRecipe(new ItemStack(ItemInit.zirconiaCitrine, 50), new ItemStack(ItemInit.zirconiaCitrine, 50), new ItemStack(ItemInit.citrineSupercharger)));
        return list;
    }
}
