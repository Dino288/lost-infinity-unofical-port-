...
public class EntityRibrex
extends Monster
implements IMaxAttack,
IBasicAI {
    public EntityRibrex(Level worldIn) {
        super(worldIn);
    ...
    protected SoundEvent func_184615_bR() {
        return SoundInit.STARFORGE_RIBREX_DEATH;
    }

    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        return SoundInit.STARFORGE_RIBREX_HURT;
    }

    protected SoundEvent func_184639_G() {
        return SoundInit.STARFORGE_RIBREX_AMBIENT;
    }
    ...
    protected ResourceLocation func_184647_J() {
        return LootTableRegistry.ENTITIES_STARFORGE_RIBREX;
    }
}
