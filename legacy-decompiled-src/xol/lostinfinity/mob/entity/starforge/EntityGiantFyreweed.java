...
public class EntityGiantFyreweed
extends EntityMultipleLives
implements IMaxAttack {
    public EntityGiantFyreweed(Level worldIn) {
        super(worldIn);
        this.func_70105_a(2.5f, 3.9f);
    }
    ...
    public void func_70636_d() {
        ...
        if (!this.field_70170_p.field_72995_K && this.field_70173_aa <= 2) {
            for (EntityGiantFyreweed near_weed : this.field_70170_p.func_72872_a(EntityGiantFyreweed.class, this.func_174813_aQ().func_72314_b(35.0, 35.0, 35.0))) {
                if (near_weed.func_110124_au().equals(this.func_110124_au())) continue;
                this.func_70106_y();
            }
        }
        if (this.field_70173_aa % 90 < 40 && this.field_70173_aa % 5 == 0) {
            ...
            for (Player near_pl : this.field_70170_p.func_72872_a(Player.class, this.func_174813_aQ().func_72314_b(45.0, 45.0, 45.0))) {
                ...
                double makeY = this.field_70163_u + 0.3;
