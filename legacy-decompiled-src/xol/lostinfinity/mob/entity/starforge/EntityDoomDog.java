...
public class EntityDoomDog
extends EntityMultipleLives
implements IMaxAttack,
IBasicAI {
    public EntityDoomDog(Level worldIn) {
        super(worldIn);
        this.func_70105_a(3.0f, 2.25f);
    }
    ...
    public boolean func_70652_k(Entity entity) {
        ...
        if (this.func_70638_az() != null) {
            if (IMaxAttack.dealMaxHealth((Entity)this, this.func_70638_az(), 3, 2.0f).didSuccessfulHit()) {
    ...
    public void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(6000.0);
