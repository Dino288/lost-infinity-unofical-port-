...
public class EntityClusterweed
extends Monster
implements IMaxAttack {
    public EntityClusterweed(Level worldIn) {
        super(worldIn);
    ...
    public void func_70636_d() {
        ...
        if (this.field_70173_aa % 60 == 0 && !this.field_70170_p.field_72995_K) {
            ...
            shot.func_70186_c(-0.5f + this.field_70146_Z.nextFloat(), 0.2f, -0.5f + this.field_70146_Z.nextFloat(), 1.0f, 0.0f);
            ...
            this.func_184185_a(SoundInit.CLUSTER_FIRE, 2.0f, 0.8f + this.field_70146_Z.nextFloat() * 0.4f);
        }
    }
