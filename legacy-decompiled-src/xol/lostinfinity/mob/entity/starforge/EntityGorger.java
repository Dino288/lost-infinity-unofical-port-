...
implements IMaxAttack {
    private static final DataParameter<Float> GMOVE_X = EntityDataManager.func_187226_a(EntityGorger.class, (DataSerializer)DataSerializers.field_187193_c);
    private static final DataParameter<Float> GMOVE_Y = EntityDataManager.func_187226_a(EntityGorger.class, (DataSerializer)DataSerializers.field_187193_c);
    private static final DataParameter<Float> GMOVE_Z = EntityDataManager.func_187226_a(EntityGorger.class, (DataSerializer)DataSerializers.field_187193_c);
    private static final DataParameter<Float> INDIV_SCALE = EntityDataManager.func_187226_a(EntityGorger.class, (DataSerializer)DataSerializers.field_187193_c);

    public EntityGorger(Level worldIn) {
        super(worldIn);
    ...
    private void setAScale() {
        ...
        this.func_70105_a(1.5f * myscl, 1.5f * myscl);
    }
