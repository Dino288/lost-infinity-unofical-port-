...
public class EntityTitanopod
extends EntityFloatingBase
implements IMaxAttack {
    public EntityTitanopod(Level worldIn) {
        super(worldIn);
        this.func_70105_a(3.0f, 16.5f);
    }
    ...
    protected EntityAIFloatAttack createShootAI() {
        return new EntityAIFloatAttack((Mob)this, (world1, parent, x, y, z, fireballStrength) -> new EntityEchoOfGravity(this.field_70170_p, parent, x, y, z, 5.0f), SoundEvents.field_187527_aQ, 20);
    }
}
