...
public class EntityBlisterweed
extends Monster
implements IMaxAttack {
    public EntityBlisterweed(Level worldIn) {
        super(worldIn);
    ...
    public void func_70636_d() {
        ...
        if (this.field_70173_aa % 4 == 0 && !this.field_70170_p.field_72995_K) {
            boolean playerNearby = false;
            Iterator iterator = this.field_70170_p.func_72872_a(Player.class, this.func_174813_aQ().func_186662_g(20.0)).iterator();
            if (iterator.hasNext()) {
            ...
            if (playerNearby) {
                ...
                double makeY = this.field_70163_u;
                double makeZ = (this.func_174813_aQ().field_72339_c + this.func_174813_aQ().field_72334_f) / 2.0;
                EntityBlightPellet shot = new EntityBlightPellet(this.field_70170_p, makeX, makeY, makeZ);
                shot.setThrower((LivingEntity)this);
                shot.func_70186_c((-0.5f + this.field_70146_Z.nextFloat()) * 0.5f, -0.2f, (-0.5f + this.field_70146_Z.nextFloat()) * 0.5f, 1.0f, 0.0f);
                this.field_70170_p.func_72838_d((Entity)shot);
                this.func_184185_a(SoundInit.BLISTERWEED_ATTACK, 2.0f, 0.8f + this.field_70146_Z.nextFloat() * 0.4f);
            }
        }
    }
