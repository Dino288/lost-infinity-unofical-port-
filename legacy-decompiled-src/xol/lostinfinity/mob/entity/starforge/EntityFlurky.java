...
public class EntityFlurky
extends Monster
implements IMaxAttack,
IBasicAI {
    private static final DataParameter<Integer> ATTACK_TIME = EntityDataManager.func_187226_a(EntityFlurky.class, (DataSerializer)DataSerializers.field_187192_b);

    public EntityFlurky(Level worldIn) {
        super(worldIn);
