...
public class FabricationStationRecipeCategory
implements IRecipeCategory {
    private final IDrawable background;
    private final IDrawable icon;
    private final String uid = "lostinfinity.fabricationstation";
    private final String title = "Fabrication Station";
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("lostinfinity", "textures/gui/fabrication_station.png");
    ...
    public FabricationStationRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableIngredient((Object)new ItemStack(BlockInit.fabricationTable));
    }
