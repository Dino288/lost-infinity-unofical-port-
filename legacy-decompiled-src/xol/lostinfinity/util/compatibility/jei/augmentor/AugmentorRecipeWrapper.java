...
import xol.lostinfinity.util.compatibility.jei.augmentor.AugmentorRecipeJEI;

public class AugmentorRecipeWrapper
implements IRecipeWrapper {
    private final List<ItemStack> inputs;
    private final ItemStack output;

    public AugmentorRecipeWrapper(List<ItemStack> inputs, ItemStack output) {
        this.inputs = inputs;
        this.output = output;
    }
    ...
    public static List<AugmentorRecipeWrapper> getRecipes(IJeiHelpers helpers) {
        IStackHelper stackHelper = helpers.getStackHelper();
        AugmentorRecipeJEI instance = AugmentorRecipeJEI.getInstance();
        Table<ItemStack, ItemStack, ItemStack> recipes = instance.getAugmentorList();
        ...
        for (Map.Entry entry : recipes.columnMap().entrySet()) {
            for (Map.Entry ent : ((Map)entry.getValue()).entrySet()) {
                ...
                AugmentorRecipeWrapper recipe = new AugmentorRecipeWrapper(inputs, output);
