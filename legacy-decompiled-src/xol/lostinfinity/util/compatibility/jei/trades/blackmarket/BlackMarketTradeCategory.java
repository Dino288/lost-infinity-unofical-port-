...
public class BlackMarketTradeCategory
implements IRecipeCategory {
    private final IDrawable background;
    private final IDrawable icon;
    private final String uid = "lostinfinity.blackmarket";
    private final String title = "Black Market Trades";
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("lostinfinity", "textures/gui/jei_traders.png");

    public BlackMarketTradeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.drawableBuilder(BACKGROUND_TEXTURE, 32, 30, 114, 34).build();
        this.icon = guiHelper.createDrawableIngredient((Object)new ItemStack(BlockInit.screenBlackMarket));
    }

    public String getUid() {
        return "lostinfinity.blackmarket";
    }

    public String getTitle() {
        return "Black Market Trades";
    }
