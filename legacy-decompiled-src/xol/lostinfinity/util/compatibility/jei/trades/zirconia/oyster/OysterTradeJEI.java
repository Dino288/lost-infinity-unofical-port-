...
public class OysterTradeJEI {
    ...
    public OysterTradeJEI() {
        ...
        this.addOysterTradeRecipe(celestialDiamond10, ItemStack.field_190927_a, new ItemStack(ItemInit.contenderPass));
        ItemStack celestialDiamond15 = new ItemStack(ItemInit.celestialDiamond);
        celestialDiamond15.func_190920_e(15);
        this.addOysterTradeRecipe(celestialDiamond15, ItemStack.field_190927_a, new ItemStack(ItemInit.mysteryBox));
        ItemStack zirconia20 = new ItemStack(ItemInit.zirconiaOyster);
        zirconia20.func_190920_e(20);
        this.addOysterTradeRecipe(zirconia20, ItemStack.field_190927_a, new ItemStack(ItemInit.ellipticalProjector));
        ItemStack zirconia50 = new ItemStack(ItemInit.zirconiaOyster);
        zirconia50.func_190920_e(50);
        this.addOysterTradeRecipe(zirconia50, zirconia50, new ItemStack(ItemInit.simpleMicrocontroller));
    }
    ...
    public void addOysterTradeRecipe(ItemStack input1, ItemStack input2, ItemStack result) {
        if (this.getOysterTradeResult(input1, input2) != ItemStack.field_190927_a) {
            return;
        }
