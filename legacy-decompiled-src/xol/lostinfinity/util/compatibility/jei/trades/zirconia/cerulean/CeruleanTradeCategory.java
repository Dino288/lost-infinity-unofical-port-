...
public class CeruleanTradeCategory
implements IRecipeCategory {
    private final IDrawable background;
    private final IDrawable icon;
    private final String uid = "lostinfinity.zirconia_cerulean";
    private final String title = "Holodeck Trades";
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("lostinfinity", "textures/gui/jei_traders.png");

    public CeruleanTradeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.drawableBuilder(BACKGROUND_TEXTURE, 32, 30, 114, 34).build();
        this.icon = guiHelper.createDrawableIngredient((Object)new ItemStack(BlockInit.screenHolodeck));
    }

    public String getUid() {
        return "lostinfinity.zirconia_cerulean";
    }

    public String getTitle() {
        return "Holodeck Trades";
    }
