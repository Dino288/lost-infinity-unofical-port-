...
public class CitrineTradeCategory
implements IRecipeCategory {
    private final IDrawable background;
    private final IDrawable icon;
    private final String uid = "lostinfinity.zirconia_citrine";
    private final String title = "Bombers Trades";
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("lostinfinity", "textures/gui/jei_traders.png");

    public CitrineTradeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.drawableBuilder(BACKGROUND_TEXTURE, 32, 30, 114, 34).build();
        this.icon = guiHelper.createDrawableIngredient((Object)new ItemStack(BlockInit.screenBombers));
    }

    public String getUid() {
        return "lostinfinity.zirconia_citrine";
    }

    public String getTitle() {
        return "Bombers Trades";
    }
