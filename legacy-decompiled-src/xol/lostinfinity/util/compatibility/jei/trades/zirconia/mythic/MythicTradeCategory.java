...
public class MythicTradeCategory
implements IRecipeCategory {
    private final IDrawable background;
    private final IDrawable icon;
    private final String uid = "lostinfinity.zirconia_mythic";
    private final String title = "Treadmill Trades";
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("lostinfinity", "textures/gui/jei_traders.png");

    public MythicTradeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.drawableBuilder(BACKGROUND_TEXTURE, 32, 30, 114, 34).build();
        this.icon = guiHelper.createDrawableIngredient((Object)new ItemStack(BlockInit.screenObstaclealley));
    }

    public String getUid() {
        return "lostinfinity.zirconia_mythic";
    }

    public String getTitle() {
        return "Treadmill Trades";
    }
