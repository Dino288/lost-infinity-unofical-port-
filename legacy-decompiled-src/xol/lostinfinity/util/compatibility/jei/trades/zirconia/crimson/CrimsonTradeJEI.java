...
public class CrimsonTradeJEI {
    ...
    public CrimsonTradeJEI() {
        ...
        this.addCrimsonTradeRecipe(celestialDiamond10, ItemStack.field_190927_a, new ItemStack(ItemInit.contenderPass));
        ItemStack celestialDiamond15 = new ItemStack(ItemInit.celestialDiamond);
        celestialDiamond15.func_190920_e(15);
        this.addCrimsonTradeRecipe(celestialDiamond15, ItemStack.field_190927_a, new ItemStack(ItemInit.mysteryBox));
        ItemStack zirconia20 = new ItemStack(ItemInit.zirconiaCrimson);
        zirconia20.func_190920_e(20);
        this.addCrimsonTradeRecipe(zirconia20, ItemStack.field_190927_a, new ItemStack(ItemInit.powerFunnel));
        ItemStack zirconia50 = new ItemStack(ItemInit.zirconiaCrimson);
        zirconia50.func_190920_e(50);
        this.addCrimsonTradeRecipe(zirconia50, zirconia50, new ItemStack(ItemInit.crimsonTransducer));
    }
    ...
    public void addCrimsonTradeRecipe(ItemStack input1, ItemStack input2, ItemStack result) {
        if (this.getCrimsonTradeResult(input1, input2) != ItemStack.field_190927_a) {
            return;
        }
