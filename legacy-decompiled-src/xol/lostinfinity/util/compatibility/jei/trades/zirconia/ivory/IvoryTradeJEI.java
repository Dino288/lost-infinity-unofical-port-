...
public class IvoryTradeJEI {
    ...
    public IvoryTradeJEI() {
        ...
        this.addIvoryTradeRecipe(celestialDiamond10, ItemStack.field_190927_a, new ItemStack(ItemInit.contenderPass));
        ItemStack celestialDiamond15 = new ItemStack(ItemInit.celestialDiamond);
        celestialDiamond15.func_190920_e(15);
        this.addIvoryTradeRecipe(celestialDiamond15, ItemStack.field_190927_a, new ItemStack(ItemInit.mysteryBox));
        ItemStack zirconia20 = new ItemStack(ItemInit.zirconiaIvory);
        zirconia20.func_190920_e(20);
        this.addIvoryTradeRecipe(zirconia20, ItemStack.field_190927_a, new ItemStack(ItemInit.chromeAlumVial));
        ItemStack zirconia50 = new ItemStack(ItemInit.zirconiaIvory);
        zirconia50.func_190920_e(50);
        this.addIvoryTradeRecipe(zirconia50, zirconia50, new ItemStack(ItemInit.inkPen));
    }
    ...
    public void addIvoryTradeRecipe(ItemStack input1, ItemStack input2, ItemStack result) {
        if (this.getIvoryTradeResult(input1, input2) != ItemStack.field_190927_a) {
            return;
        }
