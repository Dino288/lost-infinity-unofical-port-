...
public class MythicTradeJEI {
    ...
    public MythicTradeJEI() {
        ...
        this.addMythicTradeRecipe(celestialDiamond10, ItemStack.field_190927_a, new ItemStack(ItemInit.contenderPass));
        ItemStack celestialDiamond15 = new ItemStack(ItemInit.celestialDiamond);
        celestialDiamond15.func_190920_e(15);
        this.addMythicTradeRecipe(celestialDiamond15, ItemStack.field_190927_a, new ItemStack(ItemInit.mysteryBox));
        ItemStack zirconia20 = new ItemStack(ItemInit.zirconiaMythic);
        zirconia20.func_190920_e(20);
        this.addMythicTradeRecipe(zirconia20, ItemStack.field_190927_a, new ItemStack(ItemInit.spaceboundAltimeter));
        ItemStack zirconia50 = new ItemStack(ItemInit.zirconiaMythic);
        zirconia50.func_190920_e(50);
        this.addMythicTradeRecipe(zirconia50, zirconia50, new ItemStack(ItemInit.complexGyroscope));
    }
    ...
    public void addMythicTradeRecipe(ItemStack input1, ItemStack input2, ItemStack result) {
        if (this.getMythicTradeResult(input1, input2) != ItemStack.field_190927_a) {
            return;
        }
