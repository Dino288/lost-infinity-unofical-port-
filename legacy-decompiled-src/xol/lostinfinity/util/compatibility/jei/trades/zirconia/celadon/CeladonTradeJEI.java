...
public class CeladonTradeJEI {
    ...
    public CeladonTradeJEI() {
        ...
        this.addCeladonTradeRecipe(celestialDiamond10, ItemStack.field_190927_a, new ItemStack(ItemInit.contenderPass));
        ItemStack celestialDiamond15 = new ItemStack(ItemInit.celestialDiamond);
        celestialDiamond15.func_190920_e(15);
        this.addCeladonTradeRecipe(celestialDiamond15, ItemStack.field_190927_a, new ItemStack(ItemInit.mysteryBox));
        ItemStack zirconia20 = new ItemStack(ItemInit.zirconiaCeladon);
        zirconia20.func_190920_e(20);
        this.addCeladonTradeRecipe(zirconia20, ItemStack.field_190927_a, new ItemStack(ItemInit.superInductor));
        ItemStack zirconia50 = new ItemStack(ItemInit.zirconiaCeladon);
        zirconia50.func_190920_e(50);
        this.addCeladonTradeRecipe(zirconia50, zirconia50, new ItemStack(ItemInit.advancedRelay));
    }
    ...
    public void addCeladonTradeRecipe(ItemStack input1, ItemStack input2, ItemStack result) {
        if (this.getCeladonTradeResult(input1, input2) != ItemStack.field_190927_a) {
            return;
        }
