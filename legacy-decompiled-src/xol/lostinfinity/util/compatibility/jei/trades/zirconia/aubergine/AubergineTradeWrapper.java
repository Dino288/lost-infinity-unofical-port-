...
import xol.lostinfinity.util.compatibility.jei.trades.zirconia.aubergine.AubergineTradeJEI;

public class AubergineTradeWrapper
implements IRecipeWrapper {
    private final List<ItemStack> inputs;
    private final ItemStack output;

    public AubergineTradeWrapper(List<ItemStack> inputs, ItemStack output) {
        this.inputs = inputs;
        this.output = output;
    }
    ...
    public static List<AubergineTradeWrapper> getRecipes(IJeiHelpers helpers) {
        IStackHelper stackHelper = helpers.getStackHelper();
        AubergineTradeJEI instance = AubergineTradeJEI.getInstance();
        ...
        for (Map.Entry entry : recipes.columnMap().entrySet()) {
            for (Map.Entry ent : ((Map)entry.getValue()).entrySet()) {
                ...
                AubergineTradeWrapper recipe = new AubergineTradeWrapper(inputs, output);
