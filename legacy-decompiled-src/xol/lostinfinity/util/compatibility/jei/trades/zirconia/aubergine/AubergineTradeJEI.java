...
public class AubergineTradeJEI {
    ...
    public AubergineTradeJEI() {
        ...
        this.addAubergineTradeRecipe(celestialDiamond10, ItemStack.field_190927_a, new ItemStack(ItemInit.contenderPass));
        ItemStack celestialDiamond15 = new ItemStack(ItemInit.celestialDiamond);
        celestialDiamond15.func_190920_e(15);
        this.addAubergineTradeRecipe(celestialDiamond15, ItemStack.field_190927_a, new ItemStack(ItemInit.mysteryBox));
        ItemStack zirconia20 = new ItemStack(ItemInit.zirconiaAubergine);
        zirconia20.func_190920_e(20);
        this.addAubergineTradeRecipe(zirconia20, ItemStack.field_190927_a, new ItemStack(ItemInit.dangerousAccelerant));
        ItemStack zirconia50 = new ItemStack(ItemInit.zirconiaAubergine);
        zirconia50.func_190920_e(50);
        this.addAubergineTradeRecipe(zirconia50, zirconia50, new ItemStack(ItemInit.energySplitter));
    }
    ...
    public void addAubergineTradeRecipe(ItemStack input1, ItemStack input2, ItemStack result) {
        if (this.getAubergineTradeResult(input1, input2) != ItemStack.field_190927_a) {
            return;
        }
