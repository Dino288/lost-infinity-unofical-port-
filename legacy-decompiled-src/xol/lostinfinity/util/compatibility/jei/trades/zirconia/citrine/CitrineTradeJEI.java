...
public class CitrineTradeJEI {
    ...
    public CitrineTradeJEI() {
        ...
        this.addCitrineTradeRecipe(celestialDiamond10, ItemStack.field_190927_a, new ItemStack(ItemInit.contenderPass));
        ItemStack celestialDiamond15 = new ItemStack(ItemInit.celestialDiamond);
        celestialDiamond15.func_190920_e(15);
        this.addCitrineTradeRecipe(celestialDiamond15, ItemStack.field_190927_a, new ItemStack(ItemInit.mysteryBox));
        ItemStack zirconia20 = new ItemStack(ItemInit.zirconiaCitrine);
        zirconia20.func_190920_e(20);
        this.addCitrineTradeRecipe(zirconia20, ItemStack.field_190927_a, new ItemStack(ItemInit.citrineThyratron));
        ItemStack zirconia50 = new ItemStack(ItemInit.zirconiaCitrine);
        zirconia50.func_190920_e(50);
        this.addCitrineTradeRecipe(zirconia50, zirconia50, new ItemStack(ItemInit.citrineSupercharger));
    }
    ...
    public void addCitrineTradeRecipe(ItemStack input1, ItemStack input2, ItemStack result) {
        if (this.getCitrineTradeResult(input1, input2) != ItemStack.field_190927_a) {
            return;
        }
