...
public class ParticleBlueSkull
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleBlueSkull(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.scale = 3.0f + RANDOM.nextFloat() * 0.5f;
        this.field_70547_e = 40 + this.field_187136_p.nextInt(20);
        this.growSpeed = 0.2f;
        this.func_187117_a(ParticleInit.BLUE_SKULL_SPRITE);
    }

    public ParticleBlueSkull setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleBlueSkull(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
