...
public class ParticlePlasmaRift
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticlePlasmaRift(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        super(worldIn, xCoordIn, yCoordIn, zCoordIn, 0.5 - RANDOM.nextDouble(), ySpeed, 0.5 - RANDOM.nextDouble());
        this.field_187130_j = 0.1f + this.field_187136_p.nextFloat() * 0.3f;
        ...
        this.func_187117_a(ParticleInit.PLASMA_RIFT_SPRITE);
    }

    public ParticlePlasmaRift setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticlePlasmaRift(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
