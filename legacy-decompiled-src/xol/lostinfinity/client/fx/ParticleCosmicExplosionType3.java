...
public class ParticleCosmicExplosionType3
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleCosmicExplosionType3(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.func_187117_a(ParticleInit.COSMIC_EXPLOSION_TYPE3_SPRITE);
    }

    public ParticleCosmicExplosionType3 setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleCosmicExplosionType3(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
