...
extends LostParticle {
    ...
    protected ParticleDarkMagic(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.1f;
        this.func_187117_a(ParticleInit.DARK_MAGIC_SPRITE);
    }

    public ParticleDarkMagic setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleDarkMagic(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
