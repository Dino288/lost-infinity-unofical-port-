...
public class ParticleRepelField
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleRepelField(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.func_187117_a(ParticleInit.REPEL_FIELD_SPRITE);
    }

    public ParticleRepelField setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleRepelField(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
