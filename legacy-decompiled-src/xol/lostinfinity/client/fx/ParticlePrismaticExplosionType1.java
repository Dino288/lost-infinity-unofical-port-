...
public class ParticlePrismaticExplosionType1
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticlePrismaticExplosionType1(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.func_187117_a(ParticleInit.PRISMATIC_EXPLOSION_TYPE1_SPRITE);
    }

    public ParticlePrismaticExplosionType1 setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticlePrismaticExplosionType1(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
