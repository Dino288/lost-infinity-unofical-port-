...
public class ParticleNatureRing
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleNatureRing(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.scale = 1.0f;
        this.field_70547_e = (int)(7.0 / ((double)this.field_187136_p.nextFloat() * 0.8 + 0.2)) + 7;
        this.growSpeed = (0.3f + this.field_187136_p.nextFloat() / 2.0f) * 9.0f;
        this.func_187117_a(ParticleInit.NATURE_RING_SPRITE);
