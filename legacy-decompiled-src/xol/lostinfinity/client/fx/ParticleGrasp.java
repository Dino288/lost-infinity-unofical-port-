...
public class ParticleGrasp
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGrasp(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed) {
        ...
        this.func_187117_a(ParticleInit.GRASP_SPRITE);
    }

    public ParticleGrasp setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleGrasp(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
