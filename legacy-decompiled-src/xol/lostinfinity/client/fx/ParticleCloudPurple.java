...
public class ParticleCloudPurple
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleCloudPurple(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = (0.3f + this.field_187136_p.nextFloat() / 2.0f) * 2.0f;
        this.field_82339_as = 0.2f + this.field_187136_p.nextFloat() * 0.5f;
        this.func_187117_a(ParticleInit.CLOUD_PURPLE_SPRITE);
    }

    public ParticleCloudPurple setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleCloudPurple(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
