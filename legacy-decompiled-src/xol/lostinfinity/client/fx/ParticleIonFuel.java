...
public class ParticleIonFuel
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleIonFuel(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.4f;
        this.func_187117_a(ParticleInit.ION_FUEL_SPRITE);
    }

    public ParticleIonFuel setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleIonFuel(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
