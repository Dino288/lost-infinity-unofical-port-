...
public class ParticleBomberExplosion
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleBomberExplosion(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 1.0f;
        this.func_187117_a(ParticleInit.BOMBER_EXPLOSION_SPRITE);
    }

    public ParticleBomberExplosion setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleBomberExplosion(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
