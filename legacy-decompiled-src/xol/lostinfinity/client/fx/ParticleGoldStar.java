...
public class ParticleGoldStar
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGoldStar(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.func_187117_a(ParticleInit.GOLD_STAR_SPRITE);
    }

    public ParticleGoldStar setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleGoldStar(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
