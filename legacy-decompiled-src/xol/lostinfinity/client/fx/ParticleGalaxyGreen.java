...
public class ParticleGalaxyGreen
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGalaxyGreen(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.func_187117_a(ParticleInit.GALAXY_GREEN_SPRITE);
    }

    public ParticleGalaxyGreen setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleGalaxyGreen(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
