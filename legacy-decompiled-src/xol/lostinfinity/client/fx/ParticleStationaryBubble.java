...
public class ParticleStationaryBubble
extends LostParticle {
    private static final Random RANDOM = new Random();
    private float maxScale = 1.0f;

    protected ParticleStationaryBubble(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.func_187117_a(ParticleInit.STATIONARY_BUBBLE_SPRITE);
    }
    ...
    public void func_189213_a() {
        ...
        if (this.field_70547_e - this.field_70546_d < 8) {
            if ((double)this.scale > 0.5) {
                ...
                this.scale = (float)((double)this.scale - 0.25);
            }
