...
public class ParticleGlomiteWarp
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGlomiteWarp(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.func_187117_a(ParticleInit.GLOMITE_WARP_SPRITE);
    }

    public ParticleGlomiteWarp setParticleGravity(double motionY) {
    ...
    public void func_189213_a() {
        ...
        if (this.scale < 45.0f) {
            ...
            this.scale = (float)((double)this.scale + 0.05);
        } else {
            this.prevScale = this.scale;
        }
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleGlomiteWarp(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
