...
extends LostParticle {
    ...
    protected ParticleExplosion(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.func_187117_a(ParticleInit.EXPLOSION_SPRITE);
    }
