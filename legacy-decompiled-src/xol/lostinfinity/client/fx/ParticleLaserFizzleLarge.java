...
public class ParticleLaserFizzleLarge
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleLaserFizzleLarge(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.field_187129_i = this.field_187136_p.nextDouble() - 0.5;
        this.field_187131_k = this.field_187136_p.nextDouble() - 0.5;
        this.scale = RANDOM.nextFloat();
        this.field_70547_e = (int)(14.0 / (Math.random() * 0.8 + 0.2));
        this.func_187117_a(ParticleInit.LASER_FIZZLE_LARGE_SPRITE);
    }

    public ParticleLaserFizzleLarge setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleLaserFizzleLarge(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
