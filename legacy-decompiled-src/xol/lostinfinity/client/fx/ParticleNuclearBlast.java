...
public class ParticleNuclearBlast
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleNuclearBlast(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = (0.3f + this.field_187136_p.nextFloat() / 2.0f) * 9.0f / 4.0f;
        this.func_187117_a(ParticleInit.NUCLEAR_BLAST_SPRITE);
    }

    public ParticleNuclearBlast setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleNuclearBlast(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
