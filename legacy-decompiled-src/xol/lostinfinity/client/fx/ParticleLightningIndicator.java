...
public class ParticleLightningIndicator
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleLightningIndicator(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.func_187117_a(ParticleInit.LIGHTNING_INDICATOR_SPRITE);
    }
