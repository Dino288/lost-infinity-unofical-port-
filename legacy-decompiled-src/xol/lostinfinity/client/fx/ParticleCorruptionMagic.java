...
public class ParticleCorruptionMagic
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleCorruptionMagic(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.1f;
        this.func_187117_a(ParticleInit.CORRUPTION_MAGIC_SPRITE);
    }

    public ParticleCorruptionMagic setParticleGravity(double motionY) {
    ...
    public void func_189213_a() {
        ...
        this.field_187129_i *= (double)1.05f;
        this.field_187131_k *= (double)1.05f;
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleCorruptionMagic(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
