...
public class ParticleBasicStarType2
extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleBasicStarType2(Level worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.field_70547_e = (int)(5.0 / ((double)this.field_187136_p.nextFloat() * 0.8 + 0.2)) + 8;
        this.growSpeed = 0.4f;
        this.func_187117_a(ParticleInit.BASIC_STAR_TYPE2_SPRITE);
    }

    public ParticleBasicStarType2 setParticleGravity(double motionY) {
    ...
    implements IParticleFactory {
        ...
        public Particle func_178902_a(int particleID, Level world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, int ... p_178902_15_) {
            return new ParticleBasicStarType2(world, x, y, z, xSpeed, ySpeed, zSpeed);
        }
    }
}
