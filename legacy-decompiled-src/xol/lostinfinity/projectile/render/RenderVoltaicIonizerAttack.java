...
public class RenderVoltaicIonizerAttack<T extends Entity>
extends Render<T> {
    ...
    private void traverseRenderNodes(IonizerNode targetsNode, EntityVoltaicIonizerAttack entity, Vec3 playerPos, int count) {
    ...
    private void renderBolt(EntityVoltaicIonizerAttack entity, Vec3 target, Vec3 target2, Vec3 playerPos, int count) {
