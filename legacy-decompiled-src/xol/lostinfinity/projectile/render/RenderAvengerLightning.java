...
public class RenderAvengerLightning<T extends Entity>
extends Render<T> {
    ...
    public void func_76986_a(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if ((remainder = ((Entity)entity).field_70173_aa % 7) == 0) {
        ...
        EntityAvengerLightning attackEntity = (EntityAvengerLightning)entity;
        Vec3 target = attackEntity.getOriginPos();
        Vec3 target2 = attackEntity.getTargetPos();
        if (target != null && target2 != null) {
            Vec3 targetVec = new Vec3(target.field_72450_a, target.field_72448_b + attackEntity.getOriginHeight() / 2.0, target.field_72449_c);
            Vec3 target2Vec = new Vec3(target2.field_72450_a, target2.field_72448_b + attackEntity.getTargetHeight() / 2.0, target2.field_72449_c);
            ...
            float alpha = 1.0f;
            alpha = ((Entity)entity).field_70173_aa % 10 < 5 ? 0.3f + (float)(((Entity)entity).field_70173_aa % 10) * 0.14f : 1.0f - (float)(((Entity)entity).field_70173_aa % 10 - 5) * 0.14f;
