...
public class RenderIonicChakram<T extends EntityIonicChakram>
extends Render<T> {
    ...
    protected ResourceLocation getEntityTexture(T entity) {
        return this.getCustomTexture((EntityIonicChakram)entity);
    }
    ...
    public void doRender(T entity, double x, double y, double z, float yaw, float partialTick) {
        ...
        GL11.glRotated((double)(Mth.func_151238_b((double)(((EntityIonicChakram)entity).field_70173_aa - 1), (double)((EntityIonicChakram)entity).field_70173_aa, (double)partialTick) * 8.0), (double)0.0, (double)1.0, (double)0.0);
