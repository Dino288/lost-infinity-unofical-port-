...
public class EntityDarkSpell
extends EntityBaseThrowable {
    public EntityDarkSpell(Level par1World) {
        super(par1World);
    }

    public EntityDarkSpell(Level par1World, LivingEntity par2Mob) {
        super(par1World, par2Mob);
    }

    public EntityDarkSpell(Level par1World, double par2, double par4, double par6) {
        ...
        if (!this.field_70170_p.field_72995_K) {
            if (result.field_72308_g != null && this.func_85052_h() != null && result.field_72308_g != this.func_85052_h() && result.field_72308_g instanceof LivingEntity) {
                ...
                if (hit.func_110143_aJ() <= hit.func_110138_aP() / 2.0f) {
                    IMaxAttack.dealMaxHealth((Entity)this, (LivingEntity)result.field_72308_g, 1, 2.0f);
                } else {
