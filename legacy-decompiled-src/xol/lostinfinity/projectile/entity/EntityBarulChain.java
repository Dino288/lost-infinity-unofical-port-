...
public class EntityBarulChain
extends Entity
implements IMaxAttack {
    private static final DataParameter<Float> PLAYER_X = EntityDataManager.func_187226_a(EntityBarulChain.class, (DataSerializer)DataSerializers.field_187193_c);
    private static final DataParameter<Float> PLAYER_Y = EntityDataManager.func_187226_a(EntityBarulChain.class, (DataSerializer)DataSerializers.field_187193_c);
    private static final DataParameter<Float> PLAYER_Z = EntityDataManager.func_187226_a(EntityBarulChain.class, (DataSerializer)DataSerializers.field_187193_c);
    private Player target = null;
    private EntityBarul owner = null;
    ...
    public EntityBarulChain(Level worldIn) {
        super(worldIn);
    }
