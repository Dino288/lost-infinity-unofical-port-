...
public class EntityVoidLaser
extends EntityBaseThrowable {
    public EntityVoidLaser(Level par1World) {
        super(par1World);
        this.func_70105_a(0.75f, 0.75f);
    }

    public EntityVoidLaser(Level par1World, LivingEntity par2Mob) {
        super(par1World, par2Mob);
        this.func_70105_a(0.75f, 0.75f);
    }

    public EntityVoidLaser(Level par1World, double par2, double par4, double par6) {
