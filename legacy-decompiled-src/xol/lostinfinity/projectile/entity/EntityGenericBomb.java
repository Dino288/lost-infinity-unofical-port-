...
public class EntityGenericBomb
extends EntityBaseThrowable {
    public EntityGenericBomb(Level par1World) {
        super(par1World);
    }

    public EntityGenericBomb(Level par1World, LivingEntity par2Mob) {
        super(par1World, par2Mob);
    }

    public EntityGenericBomb(Level par1World, double par2, double par4, double par6) {
