...
public class EntityGloomSpell
extends EntityBaseThrowable {
    public EntityGloomSpell(Level par1World) {
        super(par1World);
    }

    public EntityGloomSpell(Level par1World, LivingEntity par2Mob) {
        super(par1World, par2Mob);
    }

    public EntityGloomSpell(Level par1World, double par2, double par4, double par6) {
