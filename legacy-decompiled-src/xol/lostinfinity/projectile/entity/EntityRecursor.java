...
extends EntityBaseThrowable {
    ...
    public EntityRecursor(Level par1World) {
        super(par1World);
        this.func_70105_a(0.75f, 0.75f);
    }

    public EntityRecursor(Level par1World, LivingEntity par2Mob) {
        super(par1World, par2Mob);
        this.func_70105_a(0.75f, 0.75f);
    }

    public EntityRecursor(Level par1World, double par2, double par4, double par6) {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            if (result.field_72308_g != null && this.func_85052_h() != null) {
                ...
                if (!result.field_72308_g.equals((Object)thrower) && result.field_72308_g instanceof LivingEntity && !this.entitiesHit.contains(result.field_72308_g)) {
                    IMaxAttack.dealTrueDamage((Entity)this, (LivingEntity)result.field_72308_g, ((LivingEntity)result.field_72308_g).func_110138_aP(), Arrays.asList("Darkborn"));
                    ...
                    for (int i = 0; i < player.field_71071_by.func_70302_i_(); ++i) {
                        ...
                        if (playerStack.func_77973_b() != ItemInit.razorOfInfinity) continue;
                    ...
                    if (!found) {
                        player.field_71071_by.func_70441_a(new ItemStack(ItemInit.razorOfInfinity));
                    }
                    this.returned = true;
                    this.func_70106_y();
                }
    ...
    public void func_70071_h_() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            this.field_70170_p.func_175688_a(ParticleInit.NIGHTMARE_MAGIC, this.field_70165_t, this.field_70163_u, this.field_70161_v, 0.25 * (-0.5 + this.field_70146_Z.nextDouble()), 0.0, 0.25 * (-0.5 + this.field_70146_Z.nextDouble()), new int[0]);
        }
    }
