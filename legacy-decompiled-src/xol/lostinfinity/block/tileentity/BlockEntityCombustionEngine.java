...
IInventory {
    ...
    public void func_73660_a() {
        ...
        if (!this.field_145850_b.field_72995_K) {
            ...
            if ((this.isBurning() || !fuel.func_190926_b()) && !this.isBurning() && this.canSmelt()) {
                this.currentBurnTime = this.burnTime = BlockEntityCombustionEngine.getItemBurnTime(fuel);
                if (this.isBurning()) {
                    sync = true;
            ...
            if (burning != this.isBurning()) {
                sync = true;
                BlockCombustionEngine.setState(this.isBurning(), this.field_145850_b, this.field_174879_c);
            }
        }
        if (sync) {
            this.func_70296_d();
    ...
    public void func_145839_a(CompoundTag compound) {
        ...
        this.currentBurnTime = BlockEntityCombustionEngine.getItemBurnTime((ItemStack)this.inventory.get(0));
    }
    ...
    private static int getItemBurnTime(ItemStack fuel) {
        ...
        if (fuel.func_77973_b() == ItemInit.sparkPlug) {
            return 200;
        }
        return 0;
    }
    ...
    public static boolean isItemFuel(ItemStack fuel) {
        return BlockEntityCombustionEngine.getItemBurnTime(fuel) > 0;
    }
