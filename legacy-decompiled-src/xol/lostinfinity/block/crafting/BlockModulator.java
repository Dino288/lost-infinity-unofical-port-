...
extends BlockBasicGui {
    ...
    public boolean func_180639_a(Level worldIn, BlockPos pos, BlockState state, Player playerIn, InteractionHand hand, Direction facing, float hitX, float hitY, float hitZ) {
        if (!playerIn.func_70093_af()) {
            BlockPos[] positions;
            int poweredCount = 0;
            Block poweredBlock = BlockInit.modulationBattery;
            ...
            if (poweredCount == 4) {
                playerIn.openGui((Object)lostinfinity.instance, GuiHandler.RegisteredGuis.MODULATOR.getId(), worldIn, pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p());
            } else if (!worldIn.field_72995_K) {
                playerIn.func_145747_a((Component)new Component((Object)((Object)TextFmt.Red) + "The modulator is unpowered."));
            }
        }
        return true;
    }
