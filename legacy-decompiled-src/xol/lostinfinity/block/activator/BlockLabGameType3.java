...
public class BlockLabGameType3
extends BlockBasic {
    public BlockLabGameType3(String name) {
    ...
    private Item canStartGame(Item held) {
        if (held.equals(ItemInit.deviantFlesh)) {
            return ItemInit.impositionMap;
        }
        if (held.equals(ItemInit.deviantMushroom)) {
            return ItemInit.retrospectionMap;
        }
        return null;
    }
}
