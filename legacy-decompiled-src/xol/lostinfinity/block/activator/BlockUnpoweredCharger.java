...
public class BlockUnpoweredCharger
extends Block {
    public BlockUnpoweredCharger(String name) {
    ...
    public boolean func_180639_a(Level worldIn, BlockPos pos, BlockState state, Player playerIn, InteractionHand hand, Direction facing, float hitX, float hitY, float hitZ) {
        if (!playerIn.func_70093_af() && playerIn.func_184586_b(hand).func_77973_b().equals(ItemInit.electrifiedQuartz)) {
            if (!worldIn.field_72995_K) {
                worldIn.func_175656_a(pos, BlockInit.labyrinthChargerLit.func_176223_P());
            }
