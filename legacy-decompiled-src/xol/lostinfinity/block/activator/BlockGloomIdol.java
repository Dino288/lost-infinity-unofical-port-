...
public class BlockGloomIdol
extends Block {
    public BlockGloomIdol(String name) {
    ...
    public boolean func_180639_a(Level worldIn, BlockPos pos, BlockState state, Player playerIn, InteractionHand hand, Direction facing, float hitX, float hitY, float hitZ) {
        if (!playerIn.func_70093_af() && playerIn.func_184586_b(hand).func_77973_b().equals(ItemInit.gloomshadowStone)) {
