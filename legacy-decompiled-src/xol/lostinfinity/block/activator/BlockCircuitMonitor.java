...
public class BlockCircuitMonitor
extends BlockBasic {
        ...
        if (!worldIn.field_72995_K) {
            ...
            for (int i = -radius; i <= radius; ++i) {
                for (int k = -radius; k <= radius; ++k) {
                    ...
                    if (checkBlock != BlockInit.circuitCalibrator || (tileEntity = worldIn.func_175625_s(check)) == null || !(tileEntity instanceof BlockEntityCircuitCalibrator)) continue;
                    BlockEntityCircuitCalibrator calibrator = (BlockEntityCircuitCalibrator)tileEntity;
