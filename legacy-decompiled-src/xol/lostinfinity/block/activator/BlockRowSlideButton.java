...
public class BlockRowSlideButton
extends BlockBasic {
    ...
    public boolean func_180639_a(Level worldIn, BlockPos pos, BlockState state, Player playerIn, InteractionHand hand, Direction facing, float hitX, float hitY, float hitZ) {
        if (!playerIn.func_70093_af() && !worldIn.field_72995_K) {
            ...
            Vec3i dir = BlockRowSlideButton.findTileDir(worldIn, pos);
            if (dir != null) {
                BlockPos nextPos = pos.func_177971_a(dir);
                while (worldIn.func_180495_p(nextPos).func_177230_c() instanceof BlockRowSlideTile) {
                    tiles.add(nextPos);
