    ...
    public boolean func_180639_a(Level worldIn, BlockPos pos, BlockState state, Player playerIn, InteractionHand hand, Direction facing, float hitX, float hitY, float hitZ) {
        if (!playerIn.func_70093_af() && this.validInput(playerIn.func_184586_b(hand).func_77973_b())) {
            if (!worldIn.field_72995_K) {
                ...
                for (EntityWhackGameMerchant merch : worldIn.func_72872_a(EntityWhackGameMerchant.class, checkBox)) {
                ...
                EntityWhackGameMerchant newMerchant = new EntityWhackGameMerchant(worldIn);
                ...
                newMerchant.setLightPositions(pos, 7, 7);
