...
public class BlockTentacleEyePurpleEmpty
extends BlockBasicPillar {
    public BlockTentacleEyePurpleEmpty(String name) {
        super(name);
    ...
    public void func_180650_b(Level world, BlockPos pos, BlockState state, Random rand) {
        if (!world.field_72995_K) {
            ...
            world.func_175656_a(pos, BlockInit.purpleTentacleEye.func_176203_a(meta));
        }
    }
}
