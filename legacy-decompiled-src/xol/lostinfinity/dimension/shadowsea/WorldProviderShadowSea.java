...
import xol.lostinfinity.dimension.shadowsea.BiomeProviderShadowSea;
import xol.lostinfinity.dimension.shadowsea.ChunkGeneratorShadowSea;
import xol.lostinfinity.init.DimensionInit;

public class WorldProviderShadowSea
extends WorldProvider {
    ...
    public Vec3 func_76562_b(float f, float f1) {
        return new Vec3((double)0.15f, (double)0.1f, (double)0.85f);
    }
