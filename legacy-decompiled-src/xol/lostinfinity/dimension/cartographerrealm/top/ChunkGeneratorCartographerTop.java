...
public class ChunkGeneratorCartographerTop
...
ICartographerRealm {
    ...
    public ChunkGeneratorCartographerTop(Level world, long seed) {
        this.world = world;
    ...
    public String[] stairsRoom() {
        String[] stairs = new String[2];
        int style = this.rand.nextInt(2);
        stairs[0] = "labyrinth/labelevatortop" + ++style;
        stairs[1] = "labyrinth/labelevatorbase" + style;
        return stairs;
    }
    ...
    public String[] twoLevelRoom() {
        ...
        room[0] = "labyrinth/labaspectroom";
        room[1] = "labyrinth/labgameroom" + ++game_pick;
        return room;
    }
    ...
    public String connectorRoom() {
        int con_pick = this.rand.nextInt(16);
        return "labyrinth/labconnector" + ++con_pick;
    }

    @Override
    public String crossRoom() {
        int cross_pick = this.rand.nextInt(8);
        return "labyrinth/labcross" + ++cross_pick;
    }

    @Override
    public String gameRoom() {
        int cross_pick = this.rand.nextInt(13);
        return "labyrinth/labspeccross" + ++cross_pick;
    }
