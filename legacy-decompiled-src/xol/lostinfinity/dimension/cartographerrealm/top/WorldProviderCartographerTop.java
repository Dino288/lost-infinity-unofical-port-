...
import xol.lostinfinity.dimension.cartographerrealm.top.ChunkGeneratorCartographerTop;
import xol.lostinfinity.init.DimensionInit;

public class WorldProviderCartographerTop
extends WorldProvider {
    ...
    public IChunkGenerator func_186060_c() {
        return new ChunkGeneratorCartographerTop(this.field_76579_a, this.field_76579_a.func_72905_C() + (long)this.getDimension());
    }
    ...
    public DimensionType func_186058_p() {
        return DimensionInit.cartographerRealmTop;
    }
