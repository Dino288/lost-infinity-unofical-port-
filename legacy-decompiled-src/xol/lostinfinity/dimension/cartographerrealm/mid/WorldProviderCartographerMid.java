...
import xol.lostinfinity.dimension.cartographerrealm.mid.ChunkGeneratorCartographerMid;
import xol.lostinfinity.init.DimensionInit;

public class WorldProviderCartographerMid
extends WorldProvider {
    ...
    public IChunkGenerator func_186060_c() {
        return new ChunkGeneratorCartographerMid(this.field_76579_a, this.field_76579_a.func_72905_C() + (long)this.getDimension());
    }
