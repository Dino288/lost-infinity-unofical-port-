...
public class LostMachineRecipeProvider implements DataProvider {
    ...
    private static void addFabrication(Map<String, JsonObject> recipes) {
        addMachine(recipes, "module_creator_power", "module", "module_container", "power_fuel", "", "module_power", 1, 75, 150, true, "");
        addMachine(recipes, "module_creator_range", "module", "module_container", "georedirection_orb", "", "module_range", 1, 75, 150, true, "");
        addMachine(recipes, "module_creator_durability", "module", "module_container", "crystal_plating", "", "module_durability", 1, 75, 150, true, "");
